...
See [Creating a notification integration to send notifications to a Google Cloud Pub/Sub topic](notifications/creating-notification-integration-google-pubsub).
...
`ERROR_INTEGRATION = <integration_name>`
:   Name of the notification integration you created in [Create a notification integration in Snowflake](notifications/creating-notification-integration-google-pubsub.html#label-notification-integration-gcp-creating-integration).
...
[Create a notification integration in Snowflake](notifications/creating-notification-integration-google-pubsub.html#label-notification-integration-gcp-creating-integration).
