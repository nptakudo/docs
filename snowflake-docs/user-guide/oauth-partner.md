...
| --- | --- | --- |
| [Tableau Desktop / Cloud](https://www.tableau.com/) [[1]](#id3) | 2019.1 or higher | Public |
| [Looker](https://looker.com) [[2]](#id4) | 6.20 or higher |  |
...
[Configure Snowflake OAuth for custom clients](oauth-custom). Tableau Desktop, Tableau Online, and Tableau Server (version 2024.2 or lower) continue to use the partner
