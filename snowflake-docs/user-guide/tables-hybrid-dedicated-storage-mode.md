...
url: "https://docs.snowflake.com/en/user-guide/tables-hybrid-dedicated-storage-mode"
---
...
This section explains how to start using [Tri-Secret Secure (TSS)](security-encryption-tss) in accounts that contain hybrid tables.
...
* You can’t enable TSS if your account already contains hybrid tables. You have to drop individual hybrid tables or any databases that contain hybrid tables, then request enablement of Dedicated Storage Mode and TSS.
  ...
  1. Set the [data retention period](data-time-travel.html#label-time-travel-data-retention-period) to `0` for either individual hybrid tables or any databases that contain hybrid tables.
...
2. Create and use hybrid tables in your account, following the [standard documentation](tables-hybrid).
