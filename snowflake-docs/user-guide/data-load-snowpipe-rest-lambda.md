...
This topic assumes you have configured Snowpipe using the instructions in [Data loading preparation using the Snowpipe REST API](data-load-snowpipe-rest-gs).
...
1. Update the security parameter:
   ...
   > :   Specifies the content of the private key file you created in [Use key pair authentication & key rotation](data-load-snowpipe-rest-gs.html#label-configuring-rsa-authentication-keys) (in [Data loading preparation using the Snowpipe REST API](data-load-snowpipe-rest-gs)).
   >
