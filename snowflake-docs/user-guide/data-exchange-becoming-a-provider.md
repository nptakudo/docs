...
url: "https://docs.snowflake.com/en/user-guide/data-exchange-becoming-a-provider"
---
...
* By default, the ACCOUNTADMIN role can perform provider functions, such as creating a listing, creating a provider profile, reviewing listing requests, etc. These tasks can be delegated to other roles. For more information, see [Grant privileges to other roles](data-exchange-marketplace-privileges).
...
If you are assigned the Data Exchange Admin role, or you have [Provider profile level privileges](data-exchange-marketplace-privileges.html#label-provider-profile-level-privileges), you can create and manage provider profiles for a Data Exchange in the Manage Exchanges tab of Snowsight.
