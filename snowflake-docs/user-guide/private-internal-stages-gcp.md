...
url: "https://docs.snowflake.com/en/user-guide/private-internal-stages-gcp"
---
...
[![Connect to internal stage using Google Private Services Connect](../_images/internal-stage-gpsc-2.png)](../_images/internal-stage-gpsc-2.png)
...
1. As a Snowflake administrator, confirm that the [ENABLE\_INTERNAL\_STAGES\_PRIVATELINK](../sql-reference/parameters.html#label-enable-internal-stages-privatelink) parameter is set to `TRUE`.
   For example:
