...
If you find that your [cloud services usage](cost-understanding-compute.html#label-cloud-services-credit-usage) is higher than expected, check if your use of
...
* [Pattern: Copy commands with poor selectivity](#label-cost-optimize-cloud-services-copy-commands)
* [Pattern: High-frequency DDL operations and cloning](#label-cost-optimize-cloud-services-cloning)
* [Pattern: High-frequency, simple queries](#label-cost-optimize-cloud-services-high-frequency-queries)
* [Pattern: High-frequency INFORMATION\_SCHEMA queries](#label-cost-optimize-cloud-services-info-schema)
* [Pattern: High-frequency SHOW commands (by data applications and third-party tools)](#label-cost-optimize-cloud-services-show-commands)
* [Pattern: Single-row inserts and fragmented schemas (by data applications)](#label-cost-optimize-cloud-services-single-inserts)
* [Pattern: Complex SQL queries](#label-cost-optimize-cloud-services-complex-query)
...
:   The consumption of cloud services by a single simple query is negligible, but running queries such as `SELECT 1`,
    ...
    **Recommendation:** Review your query frequency and determine whether the frequency is appropriately set for your use case. If you
    ...
    [SnowflakeConnection interface](../developer-guide/jdbc/jdbc-api.html#label-jdbc-snowflakeconnection). This takes advantage of caching and reduces cloud services usage.
