...
url: "https://docs.snowflake.com/en/user-guide/notifications/creating-notification-integration-amazon-sns"
---
...
To reduce latency and avoid [data egress](../cost-understanding-data-transfer) charges for sending notifications
across [regions](../intro-regions), we recommend creating the SNS topic in the same region as your Snowflake
account.
...
4. Expand the Security Token Service Regions list, find the AWS region corresponding to the
   [region](../intro-regions) where your account is located, and choose Activate if the status is
   Inactive.
...
If you plan to use the integration for notifications about errors in [tasks](../tasks-errors) or
[pipes](../data-load-snowpipe-errors), a single notification integration can support multiple tasks or pipes.
