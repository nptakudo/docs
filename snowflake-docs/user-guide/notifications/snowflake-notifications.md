...
[Notifications in Snowflake](about-notifications).
...
[the default specified in the email notification integration](email-notifications.html#label-create-email-notification-integration), set the
