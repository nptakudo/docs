...
url: "https://docs.snowflake.com/en/user-guide/notifications/creating-notification-integration-azure-event-grid"
---
...
If you plan to use the topic for notifications about errors in [tasks](../tasks-errors) or
[pipes](../data-load-snowpipe-errors), you can use a single topic for error notifications for all tasks or pipes.
