...
url: "https://docs.snowflake.com/en/user-guide/data-load-dirtables-auto-azure"
---
...
[Configure an Azure container for loading data](data-load-azure-config) for additional storage access options.
