...
This topic briefly covers how to share unstructured data files by using a secure view and [Secure Data Sharing](data-sharing-intro).
...
For more information and additional examples, see [Create and configure shares](data-sharing-provider).
...
A view allows the result of a query to be accessed like a table, and a secure view is specifically designated for data privacy. For more information, see [Overview of Views](views-introduction).
...
To choose the correct URL for your use case, see [Types of URLs available to access files](unstructured-intro.html#label-unstructured-data-urls).
