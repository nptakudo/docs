...
url: "https://docs.snowflake.com/en/user-guide/trust-center/notifications-trust-center"
---
...
* Admin users
  ...
  > > [configured to receive security notifications](../ui-snowsight-contacts).
  > >
...
see [Snowsight (the Snowflake web interface)](../ui-snowsight-profile.html#label-snowsight-verify-email-address).
...
enabling a scanner package, see [Enable scanner packages](using-the-trust-center.html#label-trust-center-enable-scanner-packages).
...
2. Switch to a role with the [SNOWFLAKE.TRUST\_CENTER\_ADMIN](overview.html#label-trust-center-requirements) application role granted to it.
...
* The scanner must be enabled. For information about enabling a scanner, see
  [Enable or disable a scanner in a scanner package](using-the-trust-center.html#label-trust-center-enable-disable-scanner).
...
4. Select the Manage scanners tab.
5. Select a scanner package from the list.
6. Select [![trust-center-vertical-more-image](../../_images/ui-trust-center-vertical-more.png)](../../_images/ui-trust-center-vertical-more.png) More for the scanner, and then select Edit notification.
