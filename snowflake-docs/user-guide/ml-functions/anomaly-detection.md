...
1. [Create an anomaly detection object](../../sql-reference/classes/anomaly-detection/commands/create-anomaly-detection.html#label-class-anomaly-detection-create),
...
* You cannot [replicate](../account-replication-intro) an instance of the ANOMALY\_DETECTION
  class.
...
You might also want to [modify your search path](../../sql-reference/snowflake-db-classes.html#label-update-search-path) to include
SNOWFLAKE.ML.

### Selecting a Virtual Warehouse

A Snowflake [virtual warehouse](../warehouses) provides the compute resources for training and using your
...
Otherwise, Snowflake suggests using a [Snowpark-optimized warehouse](../warehouses-snowpark-optimized) for larger training jobs.
...
Use [CREATE SNOWFLAKE.ML.ANOMALY\_DETECTION](../../sql-reference/classes/anomaly-detection/commands/create-anomaly-detection.html#label-class-anomaly-detection-create) to create and train a model. The model is trained on the dataset you
provide.
...
caller’s privileges. You can also provide a [query reference](../../developer-guide/stored-procedure/stored-procedures-calling-references.html#label-reference-object-query-references) instead of a
reference to a table or a view.

To create this reference, you can use the [TABLE keyword](../../sql-reference/snowflake-db-classes.html#label-class-select-from-methods) with the table name, view name,
...
To detect anomalies, call the model’s [<model\_name>!DETECT\_ANOMALIES](../../sql-reference/classes/anomaly-detection/methods/detect_anomalies.html#label-class-anomaly-detection-detect-anomalies) method:
...
[call the method in the FROM clause](../../sql-reference/snowflake-db-classes.html#label-class-select-from-methods):
...
To view a list of your models, use the [SHOW SNOWFLAKE.ML.ANOMALY\_DETECTION](../../sql-reference/classes/anomaly-detection/commands/show-anomaly-detection.html#label-class-anomaly-detection-show) command:
...
To remove a model, use the [DROP SNOWFLAKE.ML.ANOMALY\_DETECTION](../../sql-reference/classes/anomaly-detection/commands/drop-anomaly-detection.html#label-class-anomaly-detection-drop) command:
...
To create an anomaly detection model object, execute the [CREATE SNOWFLAKE.ML.ANOMALY\_DETECTION](../../sql-reference/classes/anomaly-detection/commands/create-anomaly-detection.html#label-class-anomaly-detection-create) command.
...
2. Create an anomaly detection object, and train its model on the data in that view.
   ...
   For this example, execute the [CREATE SNOWFLAKE.ML.ANOMALY\_DETECTION](../../sql-reference/classes/anomaly-detection/commands/create-anomaly-detection.html#label-class-anomaly-detection-create) command to create an anomaly detection object named
   ...
   [uses the TABLE keyword to create the reference](../../developer-guide/stored-procedure/stored-procedures-calling-references.html#label-reference-object-table-keyword). As an alternative, you can call
   ...
   [reference to a query](../../developer-guide/stored-procedure/stored-procedures-calling-references.html#label-reference-object-query-references) that uses a SELECT statement that serves as an inline
   view.
...
to detect anomalies, call the [<model\_name>!DETECT\_ANOMALIES](../../sql-reference/classes/anomaly-detection/methods/detect_anomalies.html#label-class-anomaly-detection-detect-anomalies) method of the object. For example:
...
2. Using the object for the anomaly detection model (in this example, `basic_model`, which
   ...
   call the [<model\_name>!DETECT\_ANOMALIES](../../sql-reference/classes/anomaly-detection/methods/detect_anomalies.html#label-class-anomaly-detection-detect-anomalies) method:
   ...
   prediction of the detector. For a description of the columns in this table, see [Returns](../../sql-reference/classes/anomaly-detection/methods/detect_anomalies.html#label-class-anomaly-detection-detect-anomalies-output).
...
To save your results directly to a table, use [CREATE TABLE … AS SELECT …](../../sql-reference/sql/create-table.html#label-ctas-syntax) and
[call the DETECT\_ANOMALIES method in the FROM clause](../../sql-reference/snowflake-db-classes.html#label-class-select-from-methods):
...
of the [CREATE SNOWFLAKE.ML.ANOMALY\_DETECTION](../../sql-reference/classes/anomaly-detection/commands/create-anomaly-detection.html#label-class-anomaly-detection-create) command. For example:
...
2. Create an object for the anomaly detection model, and train the model on the data in that view.
   ...
   Scroll to top
3. Using this new anomaly detection model, call the [<model\_name>!DETECT\_ANOMALIES](../../sql-reference/classes/anomaly-detection/methods/detect_anomalies.html#label-class-anomaly-detection-detect-anomalies) method,
...
anomalies, create an [OBJECT](../../sql-reference/data-types-semistructured.html#label-data-type-object) that contains configuration settings for [<model\_name>!DETECT\_ANOMALIES](../../sql-reference/classes/anomaly-detection/methods/detect_anomalies.html#label-class-anomaly-detection-detect-anomalies), and set the
`prediction_interval` key to the percentage of the observations that should be marked as anomalies.

To construct this object, you can use either an [object constant](../../sql-reference/data-types-semistructured.html#label-object-constant) or the
[OBJECT\_CONSTRUCT](../../sql-reference/functions/object_construct) function.

Then, when calling the [<model\_name>!DETECT\_ANOMALIES](../../sql-reference/classes/anomaly-detection/methods/detect_anomalies.html#label-class-anomaly-detection-detect-anomalies) method, pass in this object as the CONFIG\_OBJECT argument.
...
2. For the data to analyze, create a view or design a query that includes the new columns, and pass a reference to that
   view or query to the [<model\_name>!DETECT\_ANOMALIES](../../sql-reference/classes/anomaly-detection/methods/detect_anomalies.html#label-class-anomaly-detection-detect-anomalies) method.

The anomaly detection model detects and uses the additional columns automatically.

Note

You must provide a view or query with the same set of additional columns when executing the [CREATE SNOWFLAKE.ML.ANOMALY\_DETECTION](../../sql-reference/classes/anomaly-detection/commands/create-anomaly-detection.html#label-class-anomaly-detection-create)
command and when calling the [<model\_name>!DETECT\_ANOMALIES](../../sql-reference/classes/anomaly-detection/methods/detect_anomalies.html#label-class-anomaly-detection-detect-anomalies) method. If there is a mismatch between the columns in the training data
...
3. Create a view or design a query that returns the data to analyze with these additional columns.
   ...
   Scroll to top
4. Using this new anomaly detection object, call the [<model\_name>!DETECT\_ANOMALIES](../../sql-reference/classes/anomaly-detection/methods/detect_anomalies.html#label-class-anomaly-detection-detect-anomalies) method, passing in the new view:
...
2. For the data to analyze, create a view or design a query that includes the column that identifies the series. Call
   the [<model\_name>!DETECT\_ANOMALIES](../../sql-reference/classes/anomaly-detection/methods/detect_anomalies.html#label-class-anomaly-detection-detect-anomalies) method, passing in a reference to that view or query and
...
3. Create a view or design a query that returns the data to analyze with the series column.
   ...
   Scroll to top
4. Using this new anomaly detection object, call the [<model\_name>!DETECT\_ANOMALIES](../../sql-reference/classes/anomaly-detection/methods/detect_anomalies.html#label-class-anomaly-detection-detect-anomalies) method, passing in the new view and specifying
...
Use [Snowsight](../ui-snowsight-gs.html#label-snowsight-getting-started-sign-in) to review and visualize the results of anomaly detection. In Snowsight, when
you call the [<model\_name>!DETECT\_ANOMALIES](../../sql-reference/classes/anomaly-detection/methods/detect_anomalies.html#label-class-anomaly-detection-detect-anomalies) method, the results are displayed in a table under the worksheet.

![Results from DETECT_ANOMALIES method displayed in a table](../../_images/anomaly-detection-table.png)

To visualize the results, you can use the chart feature in Snowsight.

1. After calling the [<model\_name>!DETECT\_ANOMALIES](../../sql-reference/classes/anomaly-detection/methods/detect_anomalies.html#label-class-anomaly-detection-detect-anomalies) method, select Charts above the results table.
...
4. To display the initial visualization, select Chart.
   ...
   ![Results from DETECT_ANOMALIES method displayed in a chart](../../_images/anomaly-detection-chart.png)
5. Select Add Column on the right side of the page, and select the columns you want to visualize:
   ...
   * IS\_ANOMALY
   ...
   ![Anomaly displayed in a chart](../../_images/anomaly-detection-anomaly.png)
...
You can update your model to reflect the most up-to-date data using [Snowflake Tasks](../tasks-intro).
...
The [<model\_name>!EXPLAIN\_FEATURE\_IMPORTANCE](../../sql-reference/classes/anomaly-detection/methods/explain_feature_importance.html#label-class-anomaly-detection-explain-feature-importance) method counts the number of times the
...
[<model\_name>!EXPLAIN\_FEATURE\_IMPORTANCE](../../sql-reference/classes/anomaly-detection/methods/explain_feature_importance.html#label-class-anomaly-detection-explain-feature-importance). In this example, you first create random data with
...
For details on costs for using ML functions, see [Cost Considerations](../../guides-overview-ml-functions.html#label-ml-functions-costs) in the ML functions overview.
