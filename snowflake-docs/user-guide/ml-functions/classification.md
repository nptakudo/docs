...
* Timestamps must be [TIMESTAMP\_NTZ](../../sql-reference/data-types-datetime.html#label-datatypes-timestamp-variations) type. The model creates additional
...
You might also want to [modify your search path](../../sql-reference/snowflake-db-classes.html#label-update-search-path) to include the SNOWFLAKE.ML schema.

### Selecting a Virtual Warehouse

A Snowflake [virtual warehouse](../warehouses) provides the compute resources for training and using
...
which pass along the caller’s privileges. You can also provide a [query reference](../../developer-guide/stored-procedure/stored-procedures-calling-references.html#label-reference-object-query-references)
...
[wildcard expansion in an object literal](../../sql-reference/data-types-semistructured.html#label-object-constant-wildcard) to create key-value pairs of features
...
[wildcard expansion in an object literal](../../sql-reference/data-types-semistructured.html#label-object-constant-wildcard) to automatically create key-value pairs
for the INPUT\_DATA argument.
...
![The confusion matrix of a comparison model](../../_images/cortex-classification-confusion-matrix.png)
...
[Understanding Compute Cost](../cost-understanding-compute) for general information on Snowflake compute
costs.

For details on costs for using ML functions in general, see [Cost Considerations](../../guides-overview-ml-functions.html#label-ml-functions-costs) in the ML functions overview.
