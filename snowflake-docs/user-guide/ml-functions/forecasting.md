...
information, see [Dealing with real-world data in Time-Series Forecasting](preprocessing).
...
[call the FORECAST method in the FROM clause](../../sql-reference/snowflake-db-classes.html#label-class-select-from-methods):
...
For complete details on evaluation parameters, see [Evaluation configuration](../../sql-reference/classes/forecast/commands/create-forecast.html#label-forecast-evaluation-config).
...
To understand the relative importance of the features used in your model, use the [<model\_name>!EXPLAIN\_FEATURE\_IMPORTANCE](../../sql-reference/classes/forecast/methods/explain_feature_importance.html#label-class-forecast-explain-feature-importance)
method.
...
A Snowflake [virtual warehouse](../warehouses) provides the compute resources for training and using the
...
* You cannot [replicate](../account-replication-intro) an instance of the FORECAST class.
