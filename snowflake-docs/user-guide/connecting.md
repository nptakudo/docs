...
url: "https://docs.snowflake.com/en/user-guide/connecting"
---

# Sign in to Snowflake

You can sign in to Snowflake in several ways. If you’re getting started with Snowflake, start by using
[Snowsight](ui-snowsight), Snowflake’s browser-based web interface. After you get
...
* Your account identifier.
  ...
  your Snowflake account administrator. For more information, see [Account identifiers](admin-account-identifier).
* Your authentication method.
  ...
  methods, see [Overview of Snowflake authentication](security-authentication-overview).

## Sign in by using Snowsight

You can access [Snowsight](ui-snowsight) over the public internet or through private connectivity
...
MFA. For instructions, see [Snowsight and MFA](ui-snowsight-gs.html#label-ui-snowsight-gs-mfa-notifications).
