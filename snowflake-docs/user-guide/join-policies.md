---
title: "Join policies"
url: "https://docs.snowflake.com/en/user-guide/join-policies"
---
...
[row access policies](security-row-intro), [aggregation policies](aggregation-policies),
and [projection policies](projection-policies).
...
* A table or view contained in the primary database has a [dangling reference](database-replication-considerations.html#label-database-replication-dangling-references) to a policy in another database.
