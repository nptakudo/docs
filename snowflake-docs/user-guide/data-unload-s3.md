...
url: "https://docs.snowflake.com/en/user-guide/data-unload-s3"
---
...
The stage references a named file format object called `my_csv_unload_format`. For instructions, see [File formats to unload data](data-unload-prepare).
