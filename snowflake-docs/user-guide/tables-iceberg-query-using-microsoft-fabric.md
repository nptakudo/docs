...
url: "https://docs.snowflake.com/en/user-guide/tables-iceberg-query-using-microsoft-fabric"
---
...
* To find your Snowflake organization name, (`<orgname>`), and Snowflake account name (`<accountname>`), see [Finding the organization and account name for an account](admin-account-identifier.html#label-account-name-find).
...
2. Create a worksheet in Snowsight. For more information, see [Create worksheets in Snowsight](ui-snowsight-worksheets-gs.html#label-snowsight-worksheets-create).
...
external volume. For instructions, see [Verify an external volume](tables-iceberg-configure-external-volume.html#label-tables-iceberg-configure-external-volume-verify).
...
2. Open your worksheet in Snowsight.
   ...
   For more information, see [Opening worksheets in tabs](ui-snowsight-worksheets-gs.html#label-snowsight-open-worksheet).
