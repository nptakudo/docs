...
> * [View the task history for your account](#label-task-history-view)
...
For more information, see [Configure a task to send error notifications](tasks-errors-integrate).
