...
url: "https://docs.snowflake.com/en/user-guide/tables-iceberg-configure-external-volume-s3-private"
---
...
SnowGov) becuase of the enforcement of Federal Information Processing
...
[Configure an external volume](tables-iceberg-configure-external-volume).
...
3. Follow the steps to
   [create an external volume for S3 by using Snowsight](tables-iceberg-configure-external-volume-s3.html#label-tables-iceberg-configure-external-volume-s3-snowsight) and enable private
