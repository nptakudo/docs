...
If your authorization server is a [supported identity provider (IdP)](oauth-ext-overview.html#label-ext-oauth-overview) rather than a custom one, refer to the
