...
url: "https://docs.snowflake.com/en/user-guide/storage-management/storage-lifecycle-policies-billing"
---
...
After policy execution, you temporarily incur charges for *both* archive storage and [table storage](../cost-exploring-data-storage).
...
table storage for seven or more days, which is the 7-day [Fail-safe](../data-failsafe) period plus your
[Time Travel](../data-time-travel) retention period set by DATA\_RETENTION\_TIME\_IN\_DAYS.
...
When you query [retrieve archived data](storage-lifecycle-policies-retrieving-archived-data),
...
[CREATE TABLE … FROM ARCHIVE OF](../../sql-reference/sql/create-table.html#label-create-table-from-archive-of-syntax). This shows the number of files that
will be retrieved from archive storage. For an example, see [Retrieve archived data](storage-lifecycle-policies-retrieving-archived-data).
