...
url: "https://docs.snowflake.com/en/user-guide/storage-management/storage-lifecycle-policies-create-manage"
---
...
When you create a storage lifecycle policy, you can choose an [archive tier](storage-lifecycle-policies.html#label-slp-archive-tiers)
...
For considerations when you work with tables that have archival storage policies, see [Archival storage policies](storage-lifecycle-policies.html#label-slp-archive-limitations).
...
* You must have the necessary privileges to apply the policy. For information about required privileges, see
  [Storage lifecycle policy privileges](../security-access-control-privileges.html#label-security-access-control-slp-privileges).
...
see [Billing for storage lifecycle policies](storage-lifecycle-policies-billing).
