...
url: "https://docs.snowflake.com/en/user-guide/storage-management/storage-lifecycle-policies"
---
...
* **Supported tables**: Storage lifecycle policies are supported for standard Snowflake tables, and for
  [interactive tables](../interactive) that don’t auto-refresh.
...
* **Unsupported features**
  ...
  + [Row timestamps](../data-engineering/row-timestamps).
