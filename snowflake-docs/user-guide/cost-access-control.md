...
url: "https://docs.snowflake.com/en/user-guide/cost-access-control"
---
...
* The [organization account](organization-accounts).
* A regular account with the [ORGADMIN role enabled](organization-administrators.html#label-enabling-orgadmin-role-for-account).
