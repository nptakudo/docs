...
a [vectorized scanner](../sql-reference/sql/copy-into-table.html#label-use-vectorized-scanner).
...
(such as when you [load data from Iceberg-compatible Parquet files](tables-iceberg-load.html#label-tables-iceberg-load-add-files-copy-example)).
