...
url: "https://docs.snowflake.com/en/user-guide/tables-hybrid-test"
---
...
This topic provides information for testing [hybrid tables](tables-hybrid) in Snowflake. When
...
[getting started with hybrid tables tutorial](tutorials/getting-started-with-hybrid-tables-tutorial). If
...
[![Hybrid tables performance test curves](../_images/hybrid_tables_performance_test_result.png)](../_images/hybrid_tables_performance_test_result.png)
