...
Use of recursion in views is similar to the use of recursion in [recursive CTEs](queries-cte.html#label-recursive-common-table-expression).
...
For additional security, Snowflake supports defining a view as secure. For more details about secure views, see [Working with Secure Views](views-secure).
