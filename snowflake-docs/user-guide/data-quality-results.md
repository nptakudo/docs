...
url: "https://docs.snowflake.com/en/user-guide/data-quality-results"
---
...
[Viewing data quality results](data-quality-access-control.html#label-data-quality-access-control-view).

Note

This topic describes how you can use SQL to view the results of a DMF. To interact with a user interface to see the results of a data quality check, see [Monitoring data quality checks in Snowsight](data-quality-ui-monitor). A DMF is a building block of a data quality check.
