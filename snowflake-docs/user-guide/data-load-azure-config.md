...
:   Configure a storage integration object to delegate authentication responsibility for external cloud storage to an Azure service principal. A service principal is an identity created for use with services such as Snowflake to access Azure resources.
    ...
    * Accessing Azure blob storage in [government regions](intro-regions.html#label-us-gov-regions) using a storage integration is limited to Snowflake
...
2. From the home dashboard, choose Storage Accounts » *<storage\_account>*. Under Security + networking, choose Shared access signature.
   ...
   [![Storage Account Details in Azure Storage Console](../_images/azure-storage-sas-security.png)](../_images/azure-storage-sas-security.png)
...
7. Leave the **Allowed IP addresses** field blank, and specify either HTTPS only or HTTPS and HTTP under Allowed protocols.
   ...
   > [![Shared Access Signature Details in Azure Storage Console](../_images/azure-storage-sas-shared-access-signature.png)](../_images/azure-storage-sas-shared-access-signature.png)
...
**Next:** [Create an Azure stage](data-load-azure-create-stage)
