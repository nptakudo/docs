...
url: "https://docs.snowflake.com/en/user-guide/data-quality-access-control"
---
...
|  | USAGE privilege on the DMF | All users have USAGE on system DMFs [[1]](#id4). For custom DMFs, see [Granting privileges on a custom DMF](#label-data-quality-access-control-custom-dmf). |
...
| View associations between objects and DMFs | USAGE privilege on the DMF | All users have USAGE on system DMFs [[1]](#id4). For custom DMFs, see [Granting privileges on a custom DMF](#label-data-quality-access-control-custom-dmf). |
...
| Call a DMF manually | USAGE privilege on the DMF | All users have USAGE on system DMFs [[1]](#id4). For custom DMFs, see [Granting privileges on a custom DMF](#label-data-quality-access-control-custom-dmf). |
...
|  | USAGE privilege on the DMF | All users have USAGE on system DMFs [[2]](#id6). For custom DMFs, see [Granting privileges on a custom DMF](#label-data-quality-access-control-custom-dmf). |
