...
url: "https://docs.snowflake.com/en/user-guide/ui-snowsight/notebooks-save-share"
---
...
5. Acknowledge that some commands might not be supported in other notebook tools, and select Export.
   ...
   [import the exported notebook into another Snowflake account](notebooks-create.html#label-notebooks-create) or another tool that supports
   `.ipynb` files.
