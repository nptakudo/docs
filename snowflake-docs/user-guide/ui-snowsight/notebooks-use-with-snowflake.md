---
title: "Experience Snowflake with notebooks"
url: "https://docs.snowflake.com/en/user-guide/ui-snowsight/notebooks-use-with-snowflake"
---
...
1. In your notebook, add a Python cell, either using a [keyboard shortcut](notebooks-develop-run.html#label-notebooks-keyboard-shortcuts) or by selecting
   + Python.
