...
url: "https://docs.snowflake.com/en/user-guide/ui-snowsight/notebooks-create"
---
...
You can access notebooks through [Snowsight](../ui-snowsight-gs.html#label-snowsight-getting-started-sign-in), where you can [Create a new notebook](#label-notebooks-create) or [Open an existing notebook](#label-notebooks-existing-nb). You
...
* You are using a role with the [required privileges](notebooks-setup.html#label-notebooks-create-resources-grant-privileges).
...
6. Select Run on warehouse as your Python environment. For details on what is included in each runtime, see [Notebook runtimes](notebooks.html#label-notebook-runtime-descriptions).
...
8. Select a Notebook warehouse to run notebook-specific tasks. Snowflake recommends that you use [SYSTEM$STREAMLIT\_NOTEBOOK\_WH](../warehouses-overview.html#label-default-warehouse),
   ...
   * **Container Runtime notebooks:** 60 minutes (3,600 seconds) of inactivity
   ...
   You can change the idle timeout setting after creation from the notebook settings. For more information, see [Idle time and reconnection](notebooks-setup.html#label-notebooks-idle-time-property).
...
2. Open the file to import, such as a notebook file that was created from an application outside of Snowflake.
   ...
   [Import Python packages to use in notebooks](notebooks-import-packages). If the package you use in your imported notebook is not available, your code might not run. For
   information about adding cells, see [Develop and run code in Snowflake Notebooks](notebooks-develop-run).
...
To create a notebook from a file in Git, see [Create a notebook from a file in a Git repository](notebooks-snowgit.html#label-snowsight-notebooks-git-create).
...
4. Select a notebook to open it for editing.
   ...
   For details about editing notebooks, see [Develop and run code in Snowflake Notebooks](notebooks-develop-run).
