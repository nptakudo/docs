...
url: "https://docs.snowflake.com/en/user-guide/ui-snowsight/notebooks-import-packages"
---
...
After your organization administrator [accepts the terms](notebooks-setup.html#label-notebooks-anaconda-terms), you can import libraries to use in
Snowflake Notebooks.
...
6. Select a package to install it for use in your notebook, and optionally change the default package version
   ...
   [![Package selector.](../../_images/snowsight-ui-package-selector.png)](../../_images/snowsight-ui-package-selector.png)
...
> [![Package selector.](../../_images/snowsight-ui-package-selector-stage.png)](../../_images/snowsight-ui-package-selector-stage.png)
...
Now that all your packages are installed, [start coding in your notebook](notebooks-develop-run).
