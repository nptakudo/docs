---
title: "Getting started with Snowflake Notebooks"
url: "https://docs.snowflake.com/en/user-guide/ui-snowsight/notebooks-get-started"
---

# Getting started with Snowflake Notebooks

To start experimenting with Snowflake Notebooks, sign in to [Snowsight](../ui-snowsight-gs.html#label-snowsight-getting-started-sign-in), and [set up your account to use notebooks](notebooks-setup.html#label-notebooks-setup).
...
| --- | --- |
| [Set up Snowflake Notebook](../../_images/setup-sf-notebooks-tile.png) | [Setting up Snowflake Notebooks](notebooks-setup.html#label-notebooks-setup) Instructions for developers and admins before using Notebooks. |
| [Create Snowflake Notebook](../../_images/create-sf-notebooks-tile.png) | [Create a notebook](notebooks-create.html#label-notebooks-create) Create a new notebook from scratch or from an existing file. |
| [Develop and run code in Snowflake Notebook](../../_images/develop-sf-notebooks-tile.png) | [Develop and run code in Snowflake Notebooks](notebooks-develop-run) Create, edit, execute Python, SQL, and Markdown cells. |
...
| [Import Python packages to use in notebooks](notebooks-import-packages.html#label-notebooks-import-libraries) | Importing Python packages from Anaconda channel. |
| [Visualize and Interact with your data in Notebook](notebooks-visualize-data.html#label-notebooks-visualize-data) | Visualize data with matplotlib, plotly, or altair, and develop a data app with Streamlit. |
...
| [Keyboard shortcuts for Notebooks](notebooks-develop-run.html#label-notebooks-keyboard-shortcuts) | Leverage keyboard shortcuts to navigate and streamline the editing experience. |
...
| [Work with files in notebooks](notebooks-work-with-files) | Manage and work with files in your notebook environment. |
| [Schedule notebook runs](notebooks-schedule) | Schedule notebooks to run and execute code within Snowflake. |
| [Troubleshoot errors in Snowflake Notebooks](notebooks-troubleshoot) | Troubleshoot errors that may occur while you’re using Snowflake Notebooks. |
...
| [Set up Snowflake Notebook](../../_images/setup-sf-notebooks-tile.png) | [Setting up Snowflake Notebooks](notebooks-setup.html#label-notebooks-setup) Instructions for developers and admins before using Notebooks. |
| [Create Snowflake Notebook](../../_images/create-sf-notebooks-tile.png) | [Create a notebook](notebooks-create.html#label-notebooks-create) Create a new notebook from scratch or from an existing file. |
| [Develop and run code in Snowflake Notebook](../../_images/develop-sf-notebooks-tile.png) | [Develop and run code in Snowflake Notebooks](notebooks-develop-run) Create, edit, and execute Python, SQL, and Markdown cells. |
