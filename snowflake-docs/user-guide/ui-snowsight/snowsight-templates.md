...
url: "https://docs.snowflake.com/en/user-guide/ui-snowsight/snowsight-templates"
---
...
by `ACCOUNTADMIN`. See [Monitor credit usage with budgets](../budgets) for details on monitoring and optimizing warehouse compute costs.
