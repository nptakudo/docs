...
url: "https://docs.snowflake.com/en/user-guide/ui-snowsight/workspaces-working"
---
...
1. Hover over the target and select the vertical ellipsis [![More actions for worksheet](../../_images/snowsight-worksheet-vertical-ellipsis.png)](../../_images/snowsight-worksheet-vertical-ellipsis.png) (more actions).
...
1. In the Workspaces editor, select the horizontal ellipsis.
   ...
   > [![Format SQL query](../../_images/ui-snowsight-workspaces-format-query.png)](../../_images/ui-snowsight-workspaces-format-query.png)
...
2. Hover the mouse to the right of the line numbers. A code folding icon ([![Code folding icon to collapse and expand a code selection.](../../_images/workspaces-code-fold-chevron-down.png)](../../_images/workspaces-code-fold-chevron-down.png)) appears at the fold line.
...
To adjust your Workspaces layout, select the vertical ellipsis ([![More actions for worksheet](../../_images/snowsight-worksheet-vertical-ellipsis.png)](../../_images/snowsight-worksheet-vertical-ellipsis.png)) in the Workspaces pane and choose the appropriate option:
...
1. Find the dropped user’s PDB. Use the [SHOW DATABASES](../../sql-reference/sql/show-databases) command with a LIKE function to locate the specific database:
