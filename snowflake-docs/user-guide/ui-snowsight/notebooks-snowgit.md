...
> For more details, see [Access control requirements](../../sql-reference/sql/show-git-repositories.html#label-show-git-repositories-access-control).
...
For more details, see [Access control requirements](../../sql-reference/sql/alter-git-repository.html#label-alter-git-repository-access-control).
