...
url: "https://docs.snowflake.com/en/user-guide/ui-snowsight/notebooks-usage"
---

# Notebook usage and cost monitoring

A notebook consumes compute resources through its configured [virtual warehouses](../warehouses-overview)
or [compute pools](../../developer-guide/snowpark-container-services/working-with-compute-pool.html#label-spcs-working-with-compute-pools-default-compute-pools-for-notebooks). To manage costs and ensure efficient operations,
...
For a broader overview of compute-related cost management, see [Exploring compute cost](../cost-exploring-compute).
...
Costs for querying are associated with the underlying warehouse. For information on how warehouses work, see [Virtual warehouse credit usage](../cost-understanding-compute.html#label-virtual-warehouse-credit-usage).
