...
For more information on working with files in Git, see [Sync notebooks with a Git repository](notebooks-snowgit).
...
1. Sign in to [Snowsight](../ui-snowsight-gs.html#label-snowsight-getting-started-sign-in).
2. In the navigation menu, select Projects » Notebooks.
3. In the Files tab, next to the database object explorer, select the [![More options](../../_images/snowsight-worksheet-explorer-ellipsis.png)](../../_images/snowsight-worksheet-explorer-ellipsis.png) icon next to the file you
