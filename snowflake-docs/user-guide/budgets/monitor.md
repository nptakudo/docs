...
url: "https://docs.snowflake.com/en/user-guide/budgets/monitor"
---
...
and roles that must be granted to a role to monitor the account budget, see [Budgets roles and privileges](../budgets.html#label-budgets-roles-and-privileges).
...
and roles that must be granted to a role to monitor a custom budget, see [Budgets roles and privileges](../budgets.html#label-budgets-roles-and-privileges).
...
Select [![Clock icon](../../_images/clock-time-period-icon.svg)](../../_images/clock-time-period-icon.svg) (months to display) to filter the view by Current Month or longer time periods.
...
You can filter the view by selecting [![Budgets icon](../../_images/budgets-icon.svg)](../../_images/budgets-icon.svg) Budgets or [![Resources icon](../../_images/resources-icon.svg)](../../_images/resources-icon.svg) Resources:
...
* You can select a custom budget in the Budgets view for details on a specific budget.
  ...
  compute costs, or if you recently added an object to a budget and the [serverless background task](cost)
...
For more information, see [Budget methods](../../sql-reference/classes/budget.html#label-budget-methods).
