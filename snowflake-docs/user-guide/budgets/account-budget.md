...
url: "https://docs.snowflake.com/en/user-guide/budgets/account-budget"
---
...
For a full list of roles and privileges required for the budget administrator role, see [Budgets roles and privileges](../budgets.html#label-budgets-roles-and-privileges).
...
If you are activating the account budget for the [organization account](../organization-accounts), use the GLOBALORGADMIN
...
However, you can continue to [create custom budgets using SQL](custom-budget.html#label-create-custom-budget-sql).
...
2. In the navigation menu, select Admin » Cost management.
3. Select Budgets.
4. Select the [![Three vertical dots indicating more options](../../_images/vertical-more-icon.png)](../../_images/vertical-more-icon.png) more menu.
