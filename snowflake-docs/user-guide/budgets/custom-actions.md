...
url: "https://docs.snowflake.com/en/user-guide/budgets/custom-actions"
---
...
Custom actions don’t replace the <notifications> that Snowflake sends when consumption is expected
