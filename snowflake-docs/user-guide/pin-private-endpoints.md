...
url: "https://docs.snowflake.com/en/user-guide/pin-private-endpoints"
---
...
[network policies](network-policies) and [network rules](network-rules).
...
![Checking authorized access for inbound traffic through pinned private connectivity endpoints](../_images/pinning_privatelink_endpoints_inbound_diag.png)
...
For more information about configuring private links, see [AWS PrivateLink](admin-security-privatelink) or
[Azure Private Link](privatelink-azure).

Important

Before you pin a private endpoint, when [Configuring private connectivity for Snowsight](ui-snowsight-gs.html#label-ui-snowsight-config-private-connectivity), ensure that the endpoint uses a *regionless*
...
1. Configure [AWS PrivateLink](admin-security-privatelink) or
   [Azure Private Link](privatelink-azure) for your Snowflake account. If you already have this service configured,
...
3. Call the [SYSTEM$REGISTER\_PRIVATELINK\_ENDPOINT](../sql-reference/functions/system_register_privatelink_endpoint) system function to register the VPC endpoint with your
