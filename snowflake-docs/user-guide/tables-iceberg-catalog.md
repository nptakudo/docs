...
With the Snowflake Catalog SDK, you can query [Iceberg tables](tables-iceberg) using a third-party engine
...
To create an Iceberg table, see [Create an Apache Iceberg™ table in Snowflake](tables-iceberg-create).
...
you can set the [STORAGE\_SERIALIZATION\_POLICY](../sql-reference/parameters.html#label-storage-serialization-policy) parameter.
