...
url: "https://docs.snowflake.com/en/user-guide/sample-data-using"
---
...
Note that this example illustrates the sample database, SNOWFLAKE\_SAMPLE\_DATA, has been [shared with your account](data-sharing-intro) by Snowflake.

The `origin` column in the SHOW DATABASES output (or the Origin column in the Databases [![Databases tab](../_images/ui-navigation-database-icon.svg)](../_images/ui-navigation-database-icon.svg) page in the interface) displays the fully-qualified name of the shared
