...
![Uploading data to cloud storage using client-side encryption](../_images/e2ee-client-side-encryption-upload.png)
...
![Ingesting client-Side encrypted data into Snowflake](../_images/e2ee-client-side-encryption-ingest.png)
