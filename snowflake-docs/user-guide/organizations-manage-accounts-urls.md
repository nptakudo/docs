...
url: "https://docs.snowflake.com/en/user-guide/organizations-manage-accounts-urls"
---
...
When an account is renamed or has its organization modified, it is assigned a new [account URL](organizations-connect.html#label-connecting-via-url) that is
...
[As the organization administrator](organization-administrators), you can use [Snowsight](ui-snowsight-gs.html#label-snowsight-getting-started-sign-in) or SQL to delete an
...
[As the organization administrator](organization-administrators), you can use Snowsight or SQL to delete the
