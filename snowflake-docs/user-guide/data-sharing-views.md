...
url: "https://docs.snowflake.com/en/user-guide/data-sharing-views"
---
...
See [Use secure objects to control data access](data-sharing-secure-views).
...
[Enable non-ACCOUNTADMIN roles to perform data sharing tasks](security-access-privileges-shares).
