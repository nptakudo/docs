...
url: "https://docs.snowflake.com/en/user-guide/ui-snowsight-quick-tour"
---
...
* [Workspaces](ui-snowsight/workspaces)
* [Integrate workspaces with a Git repository](ui-snowsight/workspaces-git)
...
* [Snowflake Notebooks in Workspaces](ui-snowsight/notebooks-in-workspaces/notebooks-in-workspaces-overview)
...
* [Create and deploy Streamlit apps using Snowsight](../developer-guide/streamlit/getting-started/create-streamlit-ui)
...
* [Workspaces for dbt Projects on Snowflake](data-engineering/dbt-projects-on-snowflake-using-workspaces)
...
* [Load data using Snowsight](data-load-web-ui)
...
* [View tasks and task graphs in Snowsight](ui-snowsight-tasks)
...
* [Overview of Snowflake Intelligence](snowflake-cortex/snowflake-intelligence)
* [Snowflake Cortex AI Functions (including LLM functions)](snowflake-cortex/aisql)
* [Cortex Code](cortex-code/cortex-code)
...
* [About organizational listings](collaboration/listings/organizational/org-listing-about)
...
* [Trust Center](trust-center/overview)
...
* [Snowflake Postgres](snowflake-postgres/about)
...
* [Managing integrations in Snowsight](ui-snowsight-integrations)
...
* [Manage your user settings in Snowsight](ui-snowsight-profile)
