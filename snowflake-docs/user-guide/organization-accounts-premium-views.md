...
ORGANIZATION\_USAGE schema in the [organization account](organization-accounts)
...
For information about granting access to premium views, see [Access schema in the organization account](../sql-reference/organization-usage.html#label-org-usage-access-org-account).
