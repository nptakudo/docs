...
Snowflake generates [billing usage statements](billing-usage-statement) for customers with at least one active contract,
...
* Sign in to the [organization account](organization-accounts) as a user with the GLOBALORGADMIN role.
