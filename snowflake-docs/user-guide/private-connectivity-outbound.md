...
Support for outbound private connectivity from [U.S. SnowGov regions](intro-regions.html#label-intro-regions-snowgov-regions) is as follows:
...
:   * [Network egress using private connectivity](../developer-guide/snowpark-container-services/service-network-communications.html#label-working-with-services-jobs-egress-private)
...
* [Private connectivity to external stages for Amazon Web Services](data-load-aws-private)
* [Private connectivity to external stages and Snowpipe automation for Microsoft Azure](data-load-azure-private)
* [Private connectivity to external stages for Google Cloud](data-load-gcs-private)

## External tables

An [external table](tables-external-intro) is a Snowflake feature that allows you to query data stored in an external
...
* [Configure an Apache Iceberg™ REST catalog integration with outbound private connectivity](tables-iceberg-configure-catalog-integration-rest-private)

## External volumes for Apache Iceberg™ tables

* [Private connectivity to external volumes for Amazon Web Services](tables-iceberg-configure-external-volume-s3-private)
* [Private connectivity to external volumes for Microsoft Azure](tables-iceberg-configure-external-volume-azure-private)
* [Private connectivity to external volumes for Google Cloud](tables-iceberg-configure-external-volume-gcs-private)
