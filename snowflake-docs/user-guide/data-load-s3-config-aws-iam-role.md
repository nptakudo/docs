...
![Trust policies allowing IAM user access to S3 bucket](../_images/data-load-external-s3-stage-access-iam-role.png)
...
4. Expand the Security Token Service Regions list, find the AWS region corresponding to the [region](intro-regions) where your account is located, and choose Activate if the status is Inactive.
...
**Next:** [AWS data file encryption](data-load-s3-encrypt)
