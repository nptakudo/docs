...
url: "https://docs.snowflake.com/en/user-guide/data-load-s3-config"
---
...
* [Option 1: Configure a Snowflake storage integration to access Amazon S3](data-load-s3-config-storage-integration)
* [Option 2: Configure an AWS IAM role to access Amazon S3 — *Deprecated*](data-load-s3-config-aws-iam-role)
* [Option 3: Configure AWS IAM user credentials to access Amazon S3](data-load-s3-config-aws-iam-user)
