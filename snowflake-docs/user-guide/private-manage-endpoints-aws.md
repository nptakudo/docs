...
url: "https://docs.snowflake.com/en/user-guide/private-manage-endpoints-aws"
---
...
see [Find the cloud-provider’s name of the region for your account](admin-security-privatelink.html#label-find-csp-region-name).
...
For a description of the fields of the JSON object returned by the function, see [Returns](../sql-reference/functions/system_get_privatelink_endpoints_info.html#label-get-private-endpoints-info-json).
