...
url: "https://docs.snowflake.com/en/user-guide/tasks-events"
---
...
You can set up an [alert on new data](alerts.html#label-alerts-type-streaming) to monitor the event table. You can configure the alert
to [send a notification](notifications/about-notifications) when a task execution fails.
...
* [Key-value pairs in the resource\_attributes column](#label-task-monitor-events-resource-attributes)
* [Key-value pairs in the record column](#label-task-monitor-events-record)
