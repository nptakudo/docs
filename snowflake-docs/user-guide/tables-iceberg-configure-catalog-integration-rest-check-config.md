...
url: "https://docs.snowflake.com/en/user-guide/tables-iceberg-configure-catalog-integration-rest-check-config"
---
...
You [add that Snowflake IAM user to the trust relationship](tables-iceberg-configure-catalog-integration-rest-api-gateway.html#label-tables-iceberg-rest-catalog-integration-trust-relationship-sigv4) for
an [IAM role](tables-iceberg-configure-catalog-integration-rest-api-gateway.html#label-tables-iceberg-rest-catalog-integration-configure-iam-sigv4) with permission to access your API Gateway resources.
...
For more information, see [Configure the trust relationship in IAM](tables-iceberg-configure-catalog-integration-rest-api-gateway.html#label-tables-iceberg-rest-catalog-integration-trust-relationship-sigv4).
