...
[Data loading preparation using the Snowpipe REST API](data-load-snowpipe-rest-gs).
...
Step 2:
:   Submit a request to the [insertFiles](data-load-snowpipe-rest-apis.html#label-rest-api-insertfiles) REST endpoint to load the staged data files.
...
> :   Specify the local path to the private key file you created in [Use key pair authentication & key rotation](data-load-snowpipe-rest-gs.html#label-configuring-rsa-authentication-keys) (in [Data loading preparation using the Snowpipe REST API](data-load-snowpipe-rest-gs)).
>
...
>     :   Names of your Snowflake organization and account. For details, see [Format 1 (preferred): Account name in your organization](admin-account-identifier.html#label-account-name).
>
>     Alternatively, specify your *account locator*, along with the [region](intro-regions) and [cloud platform](intro-cloud-platforms) where the account is hosted, if required. For details, see [Format 2: Account locator in a region](admin-account-identifier.html#label-account-locator).
>
...
Snowflake provides [REST endpoints](data-load-snowpipe-rest-apis) and an [Snowflake Information Schema](../sql-reference/info-schema) table function for viewing your load history:

* REST endpoints:

  + [insertReport](data-load-snowpipe-rest-apis.html#label-rest-api-insertreport)
  + [loadHistoryScan](data-load-snowpipe-rest-apis.html#label-rest-api-loadhistoryscan)
