...
* vCPU usage for [Openflow BYOC cost and scaling considerations](data-integration/openflow/cost-byoc) and [Openflow Snowflake Deployment cost and scaling considerations](data-integration/openflow/cost-spcs).
  See [Openflow components](data-integration/openflow/about.html#label-openflow-components) for more information about Openflow components including runtimes.

This topic describes how to gain insight into historical compute costs using [Snowsight](ui-snowsight-gs.html#label-snowsight-getting-started-sign-in), or by writing queries against views in
...
For usage notes related to the Consumption page, see [Usage notes](cost-exploring-overall.html#label-cost-exploring-consumption-page-notes).
...
[credits](cost-understanding-compute.html#label-what-are-credits) consumed. To explore compute cost in currency, rather than credits, write queries against the
...
| ARCHIVE\_STORAGE\_DATA\_ RETRIEVAL\_USAGE\_HISTORY | Serverless | Bytes retrieved from archive storage for storage lifecycle policies. See [Billing for storage lifecycle policies](storage-management/storage-lifecycle-policies-billing) for more information. |
...
| CORTEX\_FUNCTIONS\_ DOCUMENT\_PROCESSING\_USAGE\_HISTORY | Serverless | Credits consumed to process documents with Document AI. |
...
| HYBRID\_TABLE\_USAGE\_HISTORY | Serverless | Credits consumed for Hybrid Table Requests resources. (As of March 1, 2026, hybrid table requests are no longer billed as a separate category.) |
...
| MATERIALIZED\_VIEW\_REFRESH\_ HISTORY | Serverless | Credits consumed the refreshing of materialized views. |
...
| QUERY\_ATTRIBUTION\_HISTORY | Warehouses | Credits consumed [per query](cost-attributing.html#label-attribute-query-cost) for warehouse usage. |
...
:   * [Query: Average hour-by-hour Snowflake spend (across all warehouses) over the past m days](#label-cost-explore-query-average-spend)
    * [Query: Credit consumption by warehouse over specific time period](#label-cost-explore-query-warehouse-time)
    * [Query: Warehouse usage over m-day average](#label-cost-explore-query-warehouse-utilization)
    * [Query: Warehouse cost attribution by query tag](cost-attributing.html#label-cost-attribute-tag-sql-resources-shared-apps).
    * [Query: Warehouse cost attribution by user](cost-attributing.html#label-cost-attribute-tag-sql-resources-shared).

Compute for Cloud Services:
:   * [Query: Billed cloud services](#label-cost-explore-query-cloud-services)
    * [Query: Total cloud services cost by type of query](#label-cost-explore-query-cloud-services-query-bytype)
    * [Query: Cloud services cost for queries of a given type](#label-cost-explore-query-cloud-services-query-type)
    * [Query: Warehouses with high cloud services usage](#label-cost-explore-query-cloud-services-warehouse)
    * [Query: Cloud services cost sorted by portion of query time](#label-cost-explore-query-cloud-services-by-query-component)
...
:   * [Query: Automatic Clustering cost history (by day, by object)](#label-cost-explore-query-autocluster-cost)
    * [Query: Automatic Clustering History & m-day average](#label-cost-explore-query-autocluster-history)

Compute for Search Optimization:
:   * [Query: Search Optimization cost history (by day, by object)](#label-cost-explore-query-search-opt-cost)
    * [Query: Search Optimization History & m-day average](#label-cost-explore-query-search-opt-history)
...
:   * [Query: Materialized Views cost history (by day, by object)](#label-cost-explore-query-materialized-cost)
    * [Query: Materialized Views History & m-day average](#label-cost-explore-query-materialized-history)
...
:   * [Query: Cumulative usage of data ingest (Snowpipe and “Copy”)](#label-cost-explore-query-snowpipe-usage)
    * [Query: Snowpipe cost history (by day, by object)](#label-cost-explore-query-snowpipe-cost)
    * [Query: Snowpipe History & m-day average](#label-cost-explore-query-snowpipe-history)

Compute and client costs for Snowpipe Streaming:
:   * [Query: Snowpipe Streaming cost](#label-cost-explore-query-snowpipe-streaming)

Compute for Serverless Alerts:
:   * [Query: Total serverless alert cost](#label-cost-explore-query-alert)

Compute for Serverless Tasks:
:   * [Query: Total serverless task cost](#label-cost-explore-query-task)

Compute for Replication:
:   * [Query: Account replication cost](#label-cost-explore-query-account-replication-cost)
    * [Query: Database replication cost history (by day, by object)](#label-cost-explore-query-replication-cost)
    * [Query: Database replication History & m-day average](#label-cost-explore-query-replication-history)

Compute for Partner Tools:
:   * [Query: Credit consumption by partner tools](#label-cost-explore-query-partner)

Compute for Hybrid Tables:
:   * [Query: Credit consumption by hybrid tables](#label-cost-explore-query-hybrid-tables)

Compute for Cortex Agents:
:   * [Query: Credit consumption by Cortex Agents](#label-cost-explore-query-cortex-agents)

Compute for Cortex Analyst:
:   * [Query: Credit consumption by Cortex Analyst](#label-cost-explore-query-cortex-analyst)

Compute for Cortex Fine-tuning:
:   * [Query: Credit consumption by Cortex Fine-tuning](#label-cost-explore-query-cortex-fine-tuning)

Compute for Cortex functions:
:   * [Query: Credit consumption by Cortex functions](#label-cost-explore-query-cortex-functions)
    * [Query: Credit consumption by Cortex functions query](#label-cost-explore-query-cortex-functions-queries)

Compute for Cortex Search:
:   * [Query: Daily credit consumption by Cortex Search](#label-cost-explore-query-cortex-search-daily)
    * [Query: Credit consumption by Cortex Search serving](#label-cost-explore-query-cortex-search-serving)

Compute for Document AI:
:   * [Query: Credit consumption by Document AI](#label-cost-explore-query-document-ai)

Compute for Snowflake Intelligence:
:   * [Query: Credit consumption by Snowflake Intelligence](#label-cost-explore-query-snowflake-intelligence)

Compute for Snowflake Notebooks:
:   * [Query: Hourly credit consumption by notebooks](#label-cost-explore-query-notebooks)
    * [Query: Cost to run a specific notebook](#label-cost-explore-query-notebooks-cost)
    * [Query: Total compute pool cost per notebook](#label-cost-explore-query-notebooks-pool-cost)
    * [Query: Identify users who ran a specific notebook](#label-cost-explore-query-notebooks-container-runtime-user)
...
:   [Usage for cloud services](cost-understanding-compute.html#label-understanding-billing-for-cloud-services-usage) is billed only if the daily consumption of cloud
...
:   This query shows the total credit consumption for hybrid tables in your account over a
    ...
    For information about hybrid table storage costs, see [Evaluate cost for hybrid tables](tables-hybrid-cost).
