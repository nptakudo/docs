...
When you use any of the available methods for [loading data into Snowflake](data-load-overview),
...
For externally managed [Iceberg tables](tables-iceberg-create), the default length for VARCHAR and BINARY columns is 128 MB.
