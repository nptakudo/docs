...
For an overview of the limitations, see [Column-level Security Limitations](security-column-intro.html#label-security-column-limitations).

## Dynamic Data Masking considerations

For additional Dynamic Data Masking Considerations, see [Column-level Security Considerations](security-column-intro.html#label-security-column-considerations).
