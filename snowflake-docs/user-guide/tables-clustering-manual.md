...
url: "https://docs.snowflake.com/en/user-guide/tables-clustering-manual"
---
...
For these reasons, as well as other benefits, we recommend using [Automatic Clustering](tables-auto-reclustering) instead of manual reclustering.
...
If manual reclustering is still available in your account, [Automatic Clustering](tables-auto-reclustering) may not be enabled yet for your account.
...
* [Viewing the Automatic Clustering status for a table](tables-auto-reclustering.html#label-viewing-auto-clustering).
* [Resuming Automatic Clustering for a table](tables-auto-reclustering.html#label-resuming-auto-clustering).

## Manually Reclustering a Table

Use [ALTER TABLE](../sql-reference/sql/alter-table) with a `RECLUSTER` clause to manually recluster a table for which a clustering key have been defined. You can use a `WHERE`
