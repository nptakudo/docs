...
url: "https://docs.snowflake.com/en/user-guide/snowflake-cortex/complete-structured-outputs"
---
...
You can use the [Snowflake Cortex LLM REST API](cortex-rest-api) to invoke
