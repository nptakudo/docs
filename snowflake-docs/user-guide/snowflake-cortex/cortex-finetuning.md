...
For details, see [Regional availability](aisql.html#label-cortex-llm-availability).
...
* [CREATE](../../sql-reference/functions/finetune-create.html#label-cortex-finetuning-create): Creates a fine-tuning job with the given training data.
* [SHOW](../../sql-reference/functions/finetune-show.html#label-cortex-finetuning-show): Lists all the fine-tuning jobs in the current account.
* [DESCRIBE](../../sql-reference/functions/finetune-describe.html#label-cortex-finetuning-describe): Describes the progress and status of a particular fine-tuning job.
* [CANCEL](../../sql-reference/functions/finetune-cancel.html#label-cortex-finetuning-cancel): Cancels a given fine-tuning job.
...
* In addition to tuning and inference charges, standard [storage](../cost-understanding-data-storage) and
  [warehouse](../cost-understanding-compute) costs apply for storing the customized adaptors and running SQL commands.
...
See [LLM Functions required privileges](aisql.html#label-cortex-llm-privileges) topic for details.

To give other roles access to use the fine-tuned model, you must grant usage on the model. For details, see
[Model privileges](../security-access-control-privileges.html#label-security-access-control-model-privileges).
...
For more information about structured outputs, see [AI\_COMPLETE structured outputs](complete-structured-outputs).
...
calling the [SNOWFLAKE.CORTEX.FINETUNE function and passing in ‘CREATE’ as the first argument](../../sql-reference/functions/finetune-create.html#label-cortex-finetuning-create)
or using Snowsight.
...
The [SNOWFLAKE.CORTEX.FINETUNE function with ‘CREATE’ as the first argument](../../sql-reference/functions/finetune-create.html#label-cortex-finetuning-create)
returns a fine-tuned model ID as the output. Use this ID to get status or job progress using the
[SNOWFLAKE.CORTEX.FINETUNE function with ‘DESCRIBE’ as the first argument](../../sql-reference/functions/finetune-describe.html#label-cortex-finetuning-describe).
...
using the [SNOWFLAKE.CORTEX.FINETUNE function with ‘DESCRIBE’ as the first argument](../../sql-reference/functions/finetune-describe.html#label-cortex-finetuning-describe).
...
[SNOWFLAKE.CORTEX.FINETUNE](../../sql-reference/functions/finetune-snowflake-cortex) function with [SHOW](../../sql-reference/functions/finetune-show.html#label-cortex-finetuning-show)
or [‘DESCRIBE’](../../sql-reference/functions/finetune-describe.html#label-cortex-finetuning-describe) as the first argument.
...
function with [CANCEL](../../sql-reference/functions/finetune-cancel.html#label-cortex-finetuning-cancel) as the first argument and the job ID as the second argument.
...
[Working with model artifacts](../../developer-guide/snowflake-ml/model-registry/overview.html#label-snowpark-model-registry-model-artifacts).

## Use your fine-tuned model for inference

Use the [COMPLETE LLM function](../../sql-reference/functions/complete-snowflake-cortex) with the name your fine-tuned model to make inferences.

This example shows a call to the [COMPLETE](../../sql-reference/functions/complete-snowflake-cortex) function with
...
Fine-tuned models can be shared to other accounts with the USAGE privilege via [Data Sharing](../data-sharing-intro).

## Replicating models

[Cross-region inference](cross-region-inference) does not support fine-tuned models. Inference must take place in the same
...
[Replicating databases and account objects across multiple accounts](../account-replication-config).
