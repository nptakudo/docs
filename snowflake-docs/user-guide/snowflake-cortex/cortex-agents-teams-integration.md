...
url: "https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-agents-teams-integration"
---
...
* **Powered by Snowflake Cortex Agents.** This integration is powered by the Snowflake Cortex Agents API, which handles
  ...
  [Snowflake Intelligence](snowflake-intelligence), avoiding duplicate
...
For more information on OAuth scopes, see [Scopes](../oauth-ext-overview.html#label-ext-oauth-scopes).
...
[Cortex Agent Object](cortex-agents-rest-api) exists in your Snowflake account for the Teams or Microsoft 365
...
To create a new agent, follow the [instructions](cortex-agents-manage.html#label-snowflake-agents-create).
...
[access control requirements section](cortex-agents.html#label-cortex-agents-access-control).
...
described in the [access control requirements section](cortex-agents.html#label-cortex-agents-access-control) of the Cortex Agents
topic.
...
restriction, see [BLOCKED\_ROLES\_LIST](../../sql-reference/sql/create-security-integration-oauth-snowflake.html#label-oauth-blocked-roles-list) in the CREATE SECURITY INTEGRATION topic.
...
have previously submitted. For instructions, see [View feedback provided by users](cortex-agents-monitor.html#label-cortex-agents-view-feedback).
...
The integration supports Snowflake [network policies](../network-policies) by forwarding the client
...
:   The integration’s functionality is tied to each user’s default Snowflake role due to an architectural constraint in
    ...
    for the agent to function correctly. While Snowflake’s [secondary roles](../security-access-control-overview.html#label-access-control-role-enforcement)
...
grants described in the [access control requirements section](cortex-agents.html#label-cortex-agents-access-control).
