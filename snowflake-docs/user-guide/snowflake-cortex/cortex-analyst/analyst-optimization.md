...
url: "https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-analyst/analyst-optimization"
---
...
* Have an existing semantic view or model with at least one [verified query](verified-query-repository).
