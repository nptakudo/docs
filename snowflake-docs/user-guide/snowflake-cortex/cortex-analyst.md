...
Want to get started with Cortex Analyst quickly? Try the [Tutorial: Answer questions about time-series revenue data with Cortex Analyst](cortex-analyst/tutorials/tutorial-1) tutorial.
...
* *Powered by state-of-the-art large language models:* By default, Cortex Analyst is powered by industry-leading models
  which run securely inside [Snowflake Cortex](aisql.html#label-cortex-llm-availability), Snowflake’s
...
* *Semantic models for high precision and accuracy:* Generic AI solutions often struggle with text-to-SQL conversions
  ...
  handling. Cortex Analyst overcomes this limitation by using a [semantic model](../views-semantic/sql) to
...
Cortex Analyst uses [Semantic Views](../views-semantic/overview) to understand your data and generate
...
* [Overview of semantic views](../views-semantic/overview)
* [YAML specification for semantic views](../views-semantic/semantic-view-yaml-spec)
* [Using SQL commands to create and manage semantic views](../views-semantic/sql)
...
For more information, see [Cortex LLM privileges](aisql.html#label-cortex-llm-privileges).
...
[Cross-region inference](cross-region-inference). Once cross-region inference is enabled, Cortex Analyst
...
A [semantic model](../views-semantic/sql) is a lightweight mechanism that addresses issues related to the language difference between
...
2. Create your semantic view using the [Semantic View Autopilot](../views-semantic/autopilot) or review the [YAML specification](../views-semantic/sql.html#label-semantic-views-create-from-yaml) to create one manually.
...
[database object explorer](../ui-snowsight-data).
...
1. Follow the directions in [Create a Streamlit app by using Snowsight](../../developer-guide/streamlit/getting-started/create-streamlit-ui.html#label-streamlit-create-app) to create a new
...
these model-specific roles. For more information, see [Role-based access control (RBAC)](aisql.html#label-cortex-llm-rbac).
...
* The models [available in your Snowflake region](aisql.html#label-cortex-llm-availability).
* The account’s [cross-region inference configuration](cross-region-inference).
* Any model-level [RBAC restrictions](aisql.html#label-cortex-llm-rbac) you have established.
...
| --- | --- | --- |
| Usage Data | Output (SQL query suggestion): Usage Data  Query result (using SQL query suggestion): Customer Data | Covered AI Features [[1]](#id2) |
