...
url: "https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-agents-feedback-rest-api"
---
...
For information about required privileges and how to query feedback events (including example SQL), see [View feedback provided by users](cortex-agents-monitor.html#label-cortex-agents-view-feedback).
