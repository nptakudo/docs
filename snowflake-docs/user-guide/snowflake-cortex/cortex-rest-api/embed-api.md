...
The Cortex REST API gives you access to an endpoint for performing [vector embeddings](../vector-embeddings), using the [AI\_EMBED](../../../sql-reference/functions/ai_embed) function.
