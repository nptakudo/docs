...
url: "https://docs.snowflake.com/en/user-guide/snowflake-cortex/document-extraction"
---
...
[Cortex AI Functions: Documents](ai-documents)).
...
AI\_EXTRACT is currently incompatible with custom [network policies](../network-policies).
...
![Example document (condominium purchase and sale agreement).](../../_images/condo-agreement.png)
...
![Table: Granger Causality Tests - P-values](../../_images/granger-causality.png)
