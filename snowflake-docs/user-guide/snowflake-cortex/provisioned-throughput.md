...
url: "https://docs.snowflake.com/en/user-guide/snowflake-cortex/provisioned-throughput"
---
...
For information about the privileges required to use a provisioned throughput, see [Provisioned Throughput privileges](../security-access-control-privileges.html#label-provisioned-throughput-privileges).
...
In the ticket, provide your [Account identifiers](../admin-account-identifier) and the PT ID. We recommend creating the ticket seven business days before the start of the term to ensure that the throughput is reserved when needed.
...
For more information about the required privileges, see [Provisioned Throughput privileges](../security-access-control-privileges.html#label-provisioned-throughput-privileges).
