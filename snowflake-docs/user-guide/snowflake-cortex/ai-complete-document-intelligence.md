...
url: "https://docs.snowflake.com/en/user-guide/snowflake-cortex/ai-complete-document-intelligence"
---
...
This feature of AI\_COMPLETE is currently in preview. Other AI\_COMPLETE capabilities are generally available and suitable for production use.
...
An advantage of AI\_COMPLETE over other [document processing AI Functions](ai-documents) is the ability to choose a
...
![Title page of "Breaking the Gridlock" EU report](../../_images/breaking-the-gridlock.png)
...
![First page of EU Resolution 1008/2008](../../_images/eu-resolution-1008-2008.png)
...
![First page of 75mm gun specification booklet](../../_images/gun-75mm-specification.png)
...
Cost is determined by the total number of [tokens processed](aisql.html#label-cortex-llm-cost-considerations), not by file
