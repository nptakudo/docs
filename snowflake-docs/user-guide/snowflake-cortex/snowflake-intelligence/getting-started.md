...
url: "https://docs.snowflake.com/en/user-guide/snowflake-cortex/snowflake-intelligence/getting-started"
---
...
1. Navigate to Snowflake Intelligence using one of the methods described in [Access the agent](deploy-agents.html#label-snowflake-intelligence-use-agent).
