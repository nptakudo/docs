...
See also [Storage costs for Time Travel and Fail-safe](data-cdp-storage-costs).
...
For more information, see [Evaluate cost for hybrid tables](tables-hybrid-cost).
