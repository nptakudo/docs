...
![Unloading data to Cloud Storage](../_images/data-unloading-gcs.png)
...
For configuration instructions, see [Configure an integration for Google Cloud Storage](data-load-gcs-config).
...
* A named storage integration called `gcs_int`. For instructions, see [Configure an integration for Google Cloud Storage](data-load-gcs-config).
* A named file format called `my_csv_unload_format`. For instructions, see [File formats to unload data](data-unload-prepare).
