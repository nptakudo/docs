...
url: "https://docs.snowflake.com/en/user-guide/snowflake-postgres/postgres-roles"
---
...
main [Leaked password protection](../leaked-password-protection). When Snowflake discovers a leaked password for one of your Snowflake Postgres roles:
