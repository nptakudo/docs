...
url: "https://docs.snowflake.com/en/user-guide/snowflake-postgres/postgres-cost"
---
...
* **Instance compute**: Compute charges are based on the [COMPUTE\_FAMILY](postgres-instance-sizes) chosen for each Snowflake Postgres
...
* **Data transfer**: Standard [Snowflake data transfer costs](../cost-understanding-data-transfer) apply for all data
