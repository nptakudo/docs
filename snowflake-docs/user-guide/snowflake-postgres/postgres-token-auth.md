...
url: "https://docs.snowflake.com/en/user-guide/snowflake-postgres/postgres-token-auth"
---
...
[Snowflake OAuth](../oauth-snowflake-overview) and [Programmatic access tokens](../programmatic-access-tokens)
...
New instance dialogue when [Creating a new instance](postgres-create-instance).
...
| snowflake\_identity | text | The snowflake user identity in USER:# form, where # is the mapped Snowflake user’s `user_id` value seen in the [USERS view](../../sql-reference/account-usage/users) view. |
