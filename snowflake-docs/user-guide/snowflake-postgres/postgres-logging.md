...
url: "https://docs.snowflake.com/en/user-guide/snowflake-postgres/postgres-logging"
---
...
active [event table](../../developer-guide/logging-tracing/event-table-setting-up).
