...
url: "https://docs.snowflake.com/en/user-guide/snowflake-postgres/postgres-extensions"
---
...
| pg\_lake | Iceberg and data lake storage | Support for tables backed by object storage formats like Iceberg, Parquet, and ORC | See [Configuring S3 Storage for pg\_lake](postgres-pg_lake) |
