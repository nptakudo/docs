...
url: "https://docs.snowflake.com/en/user-guide/snowflake-postgres/about"
---
...
Postgres major versions 16-18 are currently available. When you choose a major version for your new
instance, Snowflake automatically uses the latest minor version.
...
* Using [Snowflake Token Authentication for Snowflake Postgres](postgres-token-auth) passwords for interactive user connections.
* Using restrictive [networking policies and rules](postgres-network).
* Configuring [SSL certificate verification](postgres-ssl-certs) for your client connections to Snowflake Postgres instances.
