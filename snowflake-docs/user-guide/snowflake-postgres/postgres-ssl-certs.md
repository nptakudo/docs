...
url: "https://docs.snowflake.com/en/user-guide/snowflake-postgres/postgres-ssl-certs"
---
...
troubleshooting tips, see [Connecting to Snowflake Postgres](connecting-to-snowflakepg).
