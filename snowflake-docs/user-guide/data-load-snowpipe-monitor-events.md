...
url: "https://docs.snowflake.com/en/user-guide/data-load-snowpipe-monitor-events"
---
...
This event is emitted when the [status of a pipe](../sql-reference/functions/system_pipe_status.html#label-snowpipe-status) changes. The new status can be `RUNNING`, `PAUSED`, `STOPPED`, or `STALLED`.
...
**pipe\_lifecycle - STOPPED log-level details:**
