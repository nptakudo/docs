...
After you [create or open a worksheet](ui-snowsight-worksheets-gs), you can
[manage the worksheet](ui-snowsight-worksheets), write and execute queries, explore query results and history,
...
See [Using Snowflake Copilot](snowflake-copilot) to learn more about Snowflake Copilot and for example prompts to get you started.
...
3. Open a worksheet.
4. Hover over the tab for the worksheet and select [![More actions for worksheet](../_images/snowsight-worksheet-vertical-ellipsis.png)](../_images/snowsight-worksheet-vertical-ellipsis.png), then choose Import SQL from File.
...
2. In the navigation menu, select Projects » Worksheets.
3. Open a worksheet.
4. Hover over the tab for the worksheet and select [![More actions for worksheet](../_images/snowsight-worksheet-vertical-ellipsis.png)](../_images/snowsight-worksheet-vertical-ellipsis.png).
...
6. Hover over a specific table name and select [![More options](../_images/snowsight-worksheet-explorer-ellipsis.png)](../_images/snowsight-worksheet-explorer-ellipsis.png) » Load Data.
7. Follow the prompts to upload one or more structured or unstructured files of 50MB or less.

Refer to [Load data using Snowsight](data-load-web-ui) for more details.
...
[Visualizing worksheet data](ui-snowsight-visualizations).

Query results are cached. For more details, see [Stored results for past worksheet versions](ui-snowsight-worksheets.html#label-snowsight-worksheets-results-cache) and
[Manage worksheet history and versions](ui-snowsight-worksheets.html#label-snowsight-worksheet-history).
...
[![When you select a column, arrows display that you can use to sort a column ascending or descending.](../_images/snowsight-column-sort.png)](../_images/snowsight-column-sort.png)
...
For more details about shared worksheet results, see [Viewing results for past runs of a worksheet](ui-snowsight-worksheets.html#label-snowsight-worksheets-viewing-results).

For more details about compute cost, see [Exploring compute cost](cost-exploring-compute).
...
For information on reviewing the query profile, see [Review Query Profile](ui-snowsight-activity.html#label-snowsight-query-profile).
...
When the Results pane is visible, select [![Query history](../_images/snowsight-query-history-clock.png)](../_images/snowsight-query-history-clock.png) (Query history) to review the queries that have been
...
* Select [![Show or hide filter](../_images/snowsight-query-history-filter.png)](../_images/snowsight-query-history-filter.png) to filter by warehouse, SQL text in the query, a specific query ID, or a duration greater
...
query details for the query execution. See [Review Query History in Snowsight](ui-snowsight-activity.html#label-snowsight-activity-query-history) for more information about query details.
...
from the [query history](ui-snowsight-activity) in the following contexts:
