...
url: "https://docs.snowflake.com/en/user-guide/tables-iceberg-configure-external-volume-gcs-private"
---
...
3. Follow the steps to
   [configure an external volume for Google Cloud Storage by using Snowsight](tables-iceberg-configure-external-volume-gcs.html#label-configure-external-volume-gcs-create-snowsight)
