...
For more information, see [Creating a stage](../developer-guide/snowflake-python-api/snowflake-python-managing-data-loading.html#label-snowflake-python-create-stage).
...
**Next:** [Staging data files from a local file system](data-load-local-file-system-stage)
