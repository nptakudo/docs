...
url: "https://docs.snowflake.com/en/user-guide/search-optimization/structured-queries"
---
...
[ON clause in the ALTER TABLE … ADD SEARCH OPTIMIZATION command](../../sql-reference/sql/alter-table.html#label-alter-table-searchoptimizationaction-add)
...
* You can use the SUBSTRING keyword only with inner elements that have
  [text string](../../sql-reference/data-types-text.html#label-character-datatypes) data types.
...
* Equality predicates of the following form:
  ...
  + Explicitly casting an OBJECT or MAP element to TIMESTAMP with a specified scale:
    ...
    Scroll to top
  + Matching an ARRAY element against a value of a [supported type](semi-structured-queries.html#label-search-optimization-service-variant-predicates-types),
    ...
    Scroll to top
  + Matching an OBJECT or MAP element against a value of a [supported type](semi-structured-queries.html#label-search-optimization-service-variant-predicates-types),
    with or without an explicit cast:
...
* Predicates that use the ARRAY functions, such as the following predicates:
  ...
  + `WHERE ARRAY_CONTAINS(value_expr, array)`
    ...
    value must be one of the [supported types](semi-structured-queries.html#label-search-optimization-service-variant-predicates-types):
  ...
  + `WHERE ARRAYS_OVERLAP(ARRAY_CONSTRUCT(constant_1, constant_2, .., constant_N), array)`
    ...
    [supported types](semi-structured-queries.html#label-search-optimization-service-variant-predicates-types). The constructed ARRAY can
...
[text string](../../sql-reference/data-types-text.html#label-character-datatypes) data type.
...
The [current limitations of the search optimization service](queries-that-benefit.html#label-search-optimization-limitations) also apply to
structured types.
