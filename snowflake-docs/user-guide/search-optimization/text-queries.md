...
[ON FULL\_TEXT clause in the ALTER TABLE … ADD SEARCH OPTIMIZATION command](../../sql-reference/sql/alter-table.html#label-alter-table-searchoptimizationaction-add)
...
(This `car_sales` table and its data are described under [Querying Semi-structured Data](../querying-semistructured).)
