...
* [Data types for fixed-point numbers](../../sql-reference/data-types-numeric.html#label-data-types-for-fixed-point-numbers) (for example, INTEGER and NUMERIC)
...
* [GEOGRAPHY data type](../../sql-reference/data-types-geospatial.html#label-data-types-geography)
...
* [Interactive tables](../interactive)
* [Iceberg tables](#label-search-optimization-service-iceberg)
* [Dynamic tables](../dynamic-tables-about)
* [Transient tables](../tables-temp-transient.html#label-table-type-transient)
...
* [Temporary tables](../tables-temp-transient.html#label-table-type-temporary)

## Supported predicate types

Search optimization can improve the performance of queries using these kinds of predicates:

* [Point lookup queries using equality and IN](point-lookup-queries).
* [Join queries](join-queries).
* [Queries using scalar subqueries](scalar-subqueries).
* [Queries using scalar functions](scalar-functions).
* [Character data (text) queries using the SEARCH and SEARCH\_IP functions](text-queries).
* [Substring queries using wildcards and regular expressions](substring-queries).
* [Searches in semi-structured data](semi-structured-queries).
* [Searches in structured data](structured-queries).
* [Geospatial queries](geospatial-queries).
* [Queries using conjunctions (AND) and disjunctions (OR)](conjunctions-disjunctions).

## Support for collation

Search optimization can improve the performance of queries on columns defined with a [COLLATE clause](../../sql-reference/collation.html#label-collate-clause),
depending on the search method:

* When search optimization is [enabled](enabling) on a column using the
...
For more information about search methods, see [ALTER TABLE … ADD SEARCH OPTIMIZATION](../../sql-reference/sql/alter-table.html#label-alter-table-searchoptimizationaction-add).
...
[collation rules of precedence](../../sql-reference/collation.html#label-determining-the-collation-used-in-an-operation),
...
* Search optimization can’t be added for columns with data types that Iceberg tables don’t support, which include
  ...
  data types. For more information, see [Data types for Apache Iceberg™ tables](../tables-iceberg-data-types).
...
Search optimization doesn’t improve performance of queries that use [Time Travel](../data-time-travel)
