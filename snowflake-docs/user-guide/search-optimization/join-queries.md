...
To improve the performance of join queries, [enable search optimization](enabling)
...
Use the [ALTER TABLE … ADD SEARCH OPTIMIZATION](../../sql-reference/sql/alter-table.html#label-alter-table-searchoptimizationaction-add)
command to:
...
* [EQUAL\_NULL](../../sql-reference/functions/equal_null) equality predicates currently aren’t supported.
