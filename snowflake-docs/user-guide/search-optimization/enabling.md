...
[ADD SEARCH OPTIMIZATION](../../sql-reference/sql/alter-table.html#label-alter-table-searchoptimizationaction-add) command.
...
[get an estimate of these costs](cost-estimation.html#label-search-optimization-estimate-costs) so that you know what to expect.
...
* Enabling search optimization for a whole table enables it for point-lookup queries on all eligible columns.
  ...
  [ADD SEARCH OPTIMIZATION](../../sql-reference/sql/alter-table.html#label-alter-table-searchoptimizationaction-add) command *without* the ON clause.
...
* You can enable search optimization for a whole Apache Iceberg™ table or for specific columns in the table by using the
  ...
  [ADD SEARCH OPTIMIZATION](../../sql-reference/sql/alter-iceberg-table.html#label-alter-iceberg-table-searchoptimizationaction) command.
...
[ADD SEARCH OPTIMIZATION](../../sql-reference/sql/alter-table.html#label-alter-table-searchoptimizationaction-add) command with the ON clause.

Note

When running this command, use a role that has
[the privileges to add search optimization to the table](#label-access-control-privileges-for-search-optimization).
...
[the section on ALTER TABLE … ADD SEARCH OPTIMIZATION](../../sql-reference/sql/alter-table.html#label-alter-table-searchoptimizationaction-add).
...
analyzers. For information about the behavior of different analyzers, see [How search terms are tokenized](../../sql-reference/functions/search.html#label-how-search-terms-tokenized).
...
In addition, you can specify individual [paths](../querying-semistructured.html#label-traversing-semistructured-data) to columns of type VARIANT,
ARRAY, or OBJECT.
...
If specified, the [ANALYZER => 'analyzer\_name'](../../sql-reference/functions/search.html#label-search-analyzer) argument must be one of the choices that is documented for the
...
[Examples of ADD (and DROP) FULL\_TEXT search optimization](text-queries.html#label-search-optimization-service-queries-text-examples).
...
* As explained in the
  [description of the syntax for the search method and target](../../sql-reference/sql/alter-table-event-table.html#label-alter-table-searchoptimizationaction-search-method-target),
...
[the section on search optimization in ALTER TABLE](../../sql-reference/sql/alter-table.html#label-alter-table-searchoptimizationaction).
...
3. Run a query to verify that search optimization is working.
   ...
   See [Identifying queries that can benefit from search optimization](queries-that-benefit.html#label-search-optimization-service-when-should-you-use-search-paths).
...
[ALTER TABLE](../../sql-reference/sql/alter-table) …
[DROP SEARCH OPTIMIZATION](../../sql-reference/sql/alter-table.html#label-alter-table-searchoptimizationaction-drop) command with the ON clause.
...
For more information on the syntax, see
[the section on ALTER TABLE … DROP SEARCH OPTIMIZATION](../../sql-reference/sql/alter-table.html#label-alter-table-searchoptimizationaction-drop).

### Removing search optimization from the table

To remove the SEARCH OPTIMIZATION property from a table:

1. Switch to a role that has [the privileges to remove search optimization from the table](#label-access-control-privileges-for-search-optimization).
2. Run the [ALTER TABLE](../../sql-reference/sql/alter-table) …
   [DROP SEARCH OPTIMIZATION](../../sql-reference/sql/alter-table.html#label-alter-table-searchoptimizationaction-drop) command without the ON clause:
