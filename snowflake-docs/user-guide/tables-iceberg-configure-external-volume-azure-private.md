...
4. Follow the steps to
   [Configure an external volume for Azure in Snowsight](tables-iceberg-configure-external-volume-azure.html#label-configure-external-volume-azure-create-snowsight)
...
* [Manage private connectivity endpoints: Azure](private-manage-endpoints-azure)
