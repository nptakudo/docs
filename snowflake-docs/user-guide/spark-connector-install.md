...
* To [enforce data protection policies when querying Apache Iceberg™ tables from Apache Spark™](tables-iceberg-query-using-external-query-engine-snowflake-horizon-enforce-access-policies), you must install 3.1.6 or a later version.
...
* A supported operating system. For a list of supported operating systems, see
  [Operating system support](../release-notes/requirements.html#label-client-operating-system-support).
...
1. Search the Maven repository for your desired version of the Snowflake Spark Connector:
   ...
   * [Scala 2.12](https://central.sonatype.com/search?q=g%3Anet.snowflake%20a%3Aspark-snowflake_2.12)
   ...
   > ![Snowflake Connector for Spark download page in Maven](../_images/maven-spark-connector-new.png)
2. The Latest version label shows the most current version of the driver. If you want to download a prior version, click the
   ...
   > ![List of available packages for a Spark Connector](../_images/maven-spark-connector-browse.png)
...
3. Click the Browse link beside the version you want to download, then select and download the JAR file.
   ...
   > ![Snowflake Connector for Spark downloadable artifacts page](../_images/maven-spark-connector-artifacts-page.png)
...
see the [Snowflake Connector for Spark release notes](../release-notes/clients-drivers/spark-connector).
...
necessary AWS credentials for the location, to the connector. For more details, see [Authenticating S3 for Data Exchange](spark-connector-use.html#label-spark-auth) in the next topic.
...
with the necessary Azure credentials for the location, to the connector. For more details, see [Authenticating Azure for Data Exchange](spark-connector-use.html#label-spark-azure-auth) in the next topic.
