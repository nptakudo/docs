...
url: "https://docs.snowflake.com/en/user-guide/security-encryption-tss-self-serve-private"
---
...
mentioned in [Customer-managed keys](security-encryption-manage.html#label-customer-managed-keys). If the CMK in the composite master key hierarchy is revoked, your data can no longer be
decrypted by Snowflake.
