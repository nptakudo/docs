...
url: "https://docs.snowflake.com/en/user-guide/data-load-monitor"
---
...
Select [![Open underlying SQL query in worksheet](../_images/open-in-worksheet.png)](../_images/open-in-worksheet.png) (Open underlying SQL query in worksheet) to open a worksheet that contains the SQL query used to populate
...
Select [![Open underlying SQL query in worksheet](../_images/open-in-worksheet.png)](../_images/open-in-worksheet.png) (Open underlying SQL query in worksheet) to open a worksheet that contains the SQL query used to
