...
url: "https://docs.snowflake.com/en/user-guide/collaboration/listings/organizational/org-listings-org-user-groups"
---
...
To create an organizational listing programmatically, select the SQL tab in [Create an organizational listing](org-listing-create).
