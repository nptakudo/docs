...
url: "https://docs.snowflake.com/en/user-guide/collaboration/listings/pricing-plans-offers/providers-create-manage-offers"
---
...
* A provider profile. For more information, see [Set up a provider profile](../../../../collaboration/provider-becoming.html#label-creating-provider-profile-marketplace).
...
* An account that allows payment for listings. For more information, see [Set up Stripe to get paid for listings](../../../../collaboration/provider-becoming.html#label-set-up-stripe-listings).

## Required privileges

* You must use the ACCOUNTADMIN role or a role that has been granted the provider privileges. For more information, see [Privileges required for working with listings](../../../../collaboration/provider-becoming.html#label-permissions-required-for-working-with-listings-and-shares).
...
Each row in an Offers table includes an action button [![More actions for worksheet](../../../../_images/snowsight-worksheet-vertical-ellipsis.png)](../../../../_images/snowsight-worksheet-vertical-ellipsis.png) that you can select to view additional options for managing the offer.
...
For more information about creating billing events, see [Billable event examples](../../../../developer-guide/native-apps/adding-custom-event-billing.html#label-native-apps-custom-billing-examples).
...
1. Create an [offer manifest reference](offer-manifest-reference) named PRICING\_PLAN\_1\_DEFAULT\_OFFER.
...
6. In the Create private offer pane, perform the following steps to create a private offer:
   ...
   1. On the Offer details page, enter the following information:
      ...
      2. Specify the [data sharing account identifier](../../../admin-account-identifier) for the consumer that will receive this offer.
   ...
   2. On the Billings and payments page, select an existing pricing plan` and enter the following information.
      ...
      2. Specify the contract type:
         ...
         * Recurring (Subscription): This grants continuous access. Consumers are billed at the chosen frequency for the contract duration, and the subscription auto-renews until the consumer [cancels](consumers-manage-offers.html#label-pricing-plans-offers-consumer-cancel-purchase) the purchase.
...
1. Create an [offer manifest reference](offer-manifest-reference) named PRIVATE\_OFFER\_PRICING\_PLAN.
...
1. Create an [offer manifest reference](offer-manifest-reference) named ONE\_TIME\_PRICING\_OFFER.
...
3. In the right pane, click the Listings tab.
4. Select a paid listing in the list.
5. On the Offers tab, select the [![More actions for worksheet](../../../../_images/snowsight-worksheet-vertical-ellipsis.png)](../../../../_images/snowsight-worksheet-vertical-ellipsis.png) button for the standard offer you want to edit, and then select Edit
   offer.
...
3. In the right pane, click the Listings tab.
4. Select a paid listing in the list.
5. On the Offers tab, select Private offers, then select the [![More actions for worksheet](../../../../_images/snowsight-worksheet-vertical-ellipsis.png)](../../../../_images/snowsight-worksheet-vertical-ellipsis.png) button for the private offer you want to edit, and then select Edit.
...
6. Click the [![More actions for worksheet](../../../../_images/snowsight-worksheet-vertical-ellipsis.png)](../../../../_images/snowsight-worksheet-vertical-ellipsis.png) button for the offer you want to view and then select View details.
...
3. In the right pane, click the Listings tab.
4. Select a paid listing in the list.
5. Click the [![More actions for worksheet](../../../../_images/snowsight-worksheet-vertical-ellipsis.png)](../../../../_images/snowsight-worksheet-vertical-ellipsis.png) button for the standard offer you want to retire and then select Retire offer.
...
4. Select a paid listing in the list.
5. Click the Private Offers tab.
6. Click the [![More actions for worksheet](../../../../_images/snowsight-worksheet-vertical-ellipsis.png)](../../../../_images/snowsight-worksheet-vertical-ellipsis.png) button for the private offer you want to view and then select Copy URL.
...
4. Select a paid listing in the list.
5. Click the Private Offers tab.
6. Click the [![More actions for worksheet](../../../../_images/snowsight-worksheet-vertical-ellipsis.png)](../../../../_images/snowsight-worksheet-vertical-ellipsis.png) button for private offer you want to withdraw and then select Withdraw.
