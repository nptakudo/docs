...
url: "https://docs.snowflake.com/en/user-guide/collaboration/listings/pricing-plans-offers/providers-create-manage-pricing-plans"
---
...
* A provider profile. See [Set up a provider profile](../../../../collaboration/provider-becoming.html#label-creating-provider-profile-marketplace).
...
* An account that allows payment for listings. See [Set up Stripe to get paid for listings](../../../../collaboration/provider-becoming.html#label-set-up-stripe-listings).
...
1. Follow the steps for [sharing data on the Snowflake Marketplace](../../../../collaboration/provider-listings-creating-publishing.html#label-listing-marketplace-create).
...
1. Create a [pricing plan manifest reference](pricing-plan-manifest-reference) named PRICING\_PLAN\_1.
...
6. Select the [![More actions for worksheet](../../../../_images/snowsight-worksheet-vertical-ellipsis.png)](../../../../_images/snowsight-worksheet-vertical-ellipsis.png) button for the pricing plan you want to edit, and then select Edit plan.
