...
url: "https://docs.snowflake.com/en/user-guide/collaboration/listings/pricing-plans-offers/consumers-manage-offers"
---
...
5. To begin the checkout process, select Accept offer.
   ...
   * MCD balance: If you’re enrolled in the [Marketplace Capacity Drawdown (MCD)](../../../../collaboration/marketplace-capacity-drawdown) program, review whether you have MCD funds available. By default, any MCD funds will be applied to this purchase.
   ...
   * Billing notifications: Review your primary billing contact email address. If you have the BILLING ADMIN role, you can add recipients from the Billing contacts page. For more information, see [Update billing contact information](../../../billing-contacts).
