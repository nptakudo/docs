...
url: "https://docs.snowflake.com/en/user-guide/collaboration/organization-profiles/org-profiles-create-manage"
---
...
To learn more about organization accounts, see [Organization accounts](../../organization-accounts).
...
For details of organization profile manifest fields, see [Organization profile manifest reference](org-profile-manifest-reference).
...
> 8. Complete the organizational listing setup. See [Create an organizational listing](../listings/organizational/org-listing-create).
