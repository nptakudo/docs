...
url: "https://docs.snowflake.com/en/user-guide/views-semantic/example"
---

# Example of using SQL to create a semantic view

The following is a complete example of creating a [semantic view](overview).

The example uses the [TPC-H sample data](../sample-data-tpch) available in Snowflake. This dataset contains
