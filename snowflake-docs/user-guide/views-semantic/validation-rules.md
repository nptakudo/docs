...
url: "https://docs.snowflake.com/en/user-guide/views-semantic/validation-rules"
---
...
* **Multi-path relationship restrictions:** You can define multiple relationships between two tables, but there are limitations.
  ...
  for each path. For information, see [Defining different logical tables for different paths that join two tables](sql.html#label-semantic-views-create-logical-tables-relations).
...
These rules apply to [window function metrics](querying.html#label-semantic-views-querying-window):
