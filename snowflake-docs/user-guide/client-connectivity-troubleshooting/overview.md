...
url: "https://docs.snowflake.com/en/user-guide/client-connectivity-troubleshooting/overview"
---
...
![Non-private client connectivity to Snowflake](../../_images/arch-non-client-connectivity.png)

Non-private client connectivity to Snowflake

![Private client connectivity to Snowflake (without private connectivity to Snowflake internal stages)](../../_images/arch-private-client-connectivity-1.png)

Private client connectivity to Snowflake (without private connectivity to Snowflake internal stages 1)

![Private client connectivity to Snowflake (with private connectivity to Snowflake internal stages)](../../_images/arch-private-client-connectivity-2.png)
