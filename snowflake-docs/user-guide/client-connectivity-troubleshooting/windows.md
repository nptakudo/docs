...
url: "https://docs.snowflake.com/en/user-guide/client-connectivity-troubleshooting/windows"
---
...
After completing these steps, continue with [follow-up actions](followup-actions).
