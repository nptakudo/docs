...
See also:
:   [CONNECT BY](../sql-reference/constructs/connect-by) , [the recursive CTE portion of the WITH command](../sql-reference/constructs/with) , [Working with CTEs (Common Table Expressions)](queries-cte) , [Tabular SQL UDFs (UDTFs)](../developer-guide/udf/sql/udf-sql-tabular-functions)
...
> * [Introduction to loading semi-structured data](semistructured-intro)
> * [Querying Semi-structured Data](querying-semistructured)
...
* [WITH](../sql-reference/constructs/with) and [Working with CTEs (Common Table Expressions)](queries-cte).
