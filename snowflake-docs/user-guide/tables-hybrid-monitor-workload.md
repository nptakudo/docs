...
time interval. For more information about this behavior, see [Usage notes](../sql-reference/account-usage/query_history.html#label-query-history-usage-notes-acct-usage).

Tip

You can use the [Grouped Query History view](ui-snowsight-activity.html#label-snowsight-grouped-query-history)
