...
url: "https://docs.snowflake.com/en/user-guide/data-sharing-reader-create"
---
...
![Overview of data sharing reader accounts, where reader accounts exist within the context of a provider account while consumer accounts are external to the provider account.](../_images/data-sharing-reader.png)
...
To limit usage, set up a [resource monitor for the warehouse](data-sharing-reader-config.html#label-reader-create-resource-monitor).
...
You must use SQL commands to rename a reader account. For instructions, see [Renaming an account](organizations-manage-accounts-rename).
...
In the event of an outage in a region, you can use [Client Redirect](client-redirect) to provide continued access to
...
see [Configuring Client Redirect and reader accounts](client-redirect.html#label-client-redirect-reader-accounts).
