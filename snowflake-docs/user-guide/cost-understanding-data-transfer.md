...
url: "https://docs.snowflake.com/en/user-guide/cost-understanding-data-transfer"
---
...
* [Unloading data](data-unload-overview) - Unloading data from Snowflake to Amazon, Google Cloud Storage, or Microsoft Azure.
...
* [Replicating Data](account-replication-intro) - Replication of databases, creating a snapshot of the database to a
  secondary database.
  ...
  Snowflake account is hosted. See also [Replication Billing](account-replication-cost).
...
* [Writing external functions](../sql-reference/external-functions) - Use of external functions to transfer data from your Snowflake account to AWS, Microsoft
  Azure, or Google Public cloud. See also [External Functions Billing](../sql-reference/external-functions-introduction.html#label-external-functions-billing).
...
* [Cross-region/cross-cloud Iceberg writes](tables-iceberg.html#label-tables-iceberg-cross-cloud-support) - When you [use Snowflake as the catalog](tables-iceberg.html#label-tables-iceberg-snowflake-as-catalog),
...
> * [Exploring data transfer cost](cost-exploring-data-transfer)
