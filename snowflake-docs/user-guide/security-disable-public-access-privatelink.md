...
url: "https://docs.snowflake.com/en/user-guide/security-disable-public-access-privatelink"
---
...
about using URLs to connect to your Snowflake account, see [Connecting with a URL](organizations-connect.html#label-connecting-via-url).
...
see [Controlling network traffic with network policies](network-policies).
