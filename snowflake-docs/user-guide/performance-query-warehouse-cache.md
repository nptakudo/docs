...
See also [Using Persisted Query Results](querying-persisted-results), which explains how the results of specific queries may be cached and reused.
...
* For [tasks](tasks-intro), Snowflake recommends immediate suspension.
