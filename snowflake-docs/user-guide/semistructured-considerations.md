...
url: "https://docs.snowflake.com/en/user-guide/semistructured-considerations"
---
...
[VARIANT](../sql-reference/data-types-semistructured.html#label-data-type-variant) values that contain semi-structured data. This can be explicitly-constructed
[hierarchical data](semistructured-intro.html#label-hierarchical-data) or data that you have loaded from semi-structured data formats such as
...
For more information, see [VARIANT](../sql-reference/data-types-semistructured.html#label-data-type-variant).
...
When you construct an [ARRAY](../sql-reference/data-types-semistructured.html#label-data-type-array) value, you can specify array elements that contain
