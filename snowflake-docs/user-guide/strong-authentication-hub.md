...
url: "https://docs.snowflake.com/en/user-guide/strong-authentication-hub"
---
...
tool for meeting the deadlines associated with the [deprecation of single-factor passwords](security-mfa-rollout).
