...
url: "https://docs.snowflake.com/en/user-guide/setup"
---
...
* Snowflake interfaces:
  ...
  + [Snowsight](ui-snowsight), Snowflake’s browser-based web interface
  + Command-line clients:

    - [Snowflake CLI](../developer-guide/snowflake-cli/index), for developer-centric workloads and SQL operations
    - [SnowSQL](snowsql), for SQL operations
...
* Applications:
  ...
  + You can access Snowflake through an application. Snowflake provides several ways to create and use applications.
    ...
    available on the [Snowflake Marketplace](../collaboration/collaboration-marketplace-about) or in the
    [Snowflake ecosystem](ecosystem-all).

For information about these tools and interfaces, see [Applications and tools for connecting to Snowflake](../guides-overview-connecting).

For pricing and service information, see the [pricing page](https://www.snowflake.com/pricing/) on the Snowflake website.

For more information about free trial accounts, see [Trial accounts](admin-trial-account).
