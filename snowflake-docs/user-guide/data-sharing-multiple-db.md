...
In addition to performing all the [standard steps to share data](data-sharing-provider.html#label-share-create), you must also grant the REFERENCE\_USAGE privilege
...
[database role](security-access-control-overview.html#label-access-control-overview-role-types) and you cannot use a database role to grant a secure view
...
secure UDF, see [Creating a Secure UDF or Stored Procedure](../developer-guide/secure-udf-procedure.html#label-secure-udf-procedure-creating).
...
![Relationship between databases, database objects, shares, and accounts](../_images/data-sharing-multiple-databases2.png)
...
For instructions, see [Example 3: Share data from multiple databases](secure-data-sharing-across-regions-platforms.html#label-share-data-multi-db-group).
...
[![Relationship between databases, database objects, shares, and accounts](../_images/data-sharing-multiple-databases1.png)](../_images/data-sharing-multiple-databases1.png)
