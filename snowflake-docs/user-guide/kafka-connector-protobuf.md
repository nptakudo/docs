...
Install the Kafka connector using the instructions in [Installing and configuring the Kafka connector](kafka-connector-install).
...
2. Configure the converter properties in the file. For information about the Kafka connector properties in general, see [Kafka configuration properties](kafka-connector-install.html#label-kafka-properties).
...
2. Add the `value.converter.protoClassName` property to the file. This property specifies the protocol buffer class to use to deserialize messages (e.g. `com.google.protobuf.Int32Value`).
   ...
   For information about the Kafka connector properties in general, see [Kafka configuration properties](kafka-connector-install.html#label-kafka-properties).
