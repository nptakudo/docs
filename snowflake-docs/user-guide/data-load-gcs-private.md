...
url: "https://docs.snowflake.com/en/user-guide/data-load-gcs-private"
---
...
Storage integration
:   The following examples shows how you can specify the USE\_PRIVATELINK\_ENDPOINT property when you create a storage integration that has one or more locations:
...
3. Create a storage integration and be sure to specify TRUE as the value for the USE\_PRIVATELINK\_ENDPOINT property. For example:
   ...
   For information about creating a role for the storage integration, see [Configure an integration for Google Cloud Storage](data-load-gcs-config).
