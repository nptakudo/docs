...
url: "https://docs.snowflake.com/en/user-guide/scim-api-references"
---
...
* [User API](scim-user-api-reference): Allows identity providers to do the following actions:
...
* [Group API](scim-group-api-reference): Allows identity providers to do the following actions:
