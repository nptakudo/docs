...
:   Specifies the name of a notification integration created using [CREATE NOTIFICATION INTEGRATION](../sql-reference/sql/create-notification-integration). For more information, see
    [AWS SNS](notifications/creating-notification-integration-amazon-sns), [Google Pub/Sub](notifications/creating-notification-integration-google-pubsub), or [Azure Event Grid](notifications/creating-notification-integration-azure-event-grid).
...
[AWS SNS](notifications/creating-notification-integration-amazon-sns), [Google Pub/Sub](notifications/creating-notification-integration-google-pubsub), or [Azure Event Grid](notifications/creating-notification-integration-azure-event-grid) platform level notifications.
