...
url: "https://docs.snowflake.com/en/user-guide/object-tagging/inheritance"
---
...
> [![Child objects in the Snowflake securable object hierarchy inherit tags](../../_images/securable-object-hierarchy-org-to-column.png)](../../_images/securable-object-hierarchy-org-to-column.png)
...
[Automatic tag propagation with user-defined tags](propagation).

## Overriding tag inheritance

It’s possible to override the value of an inherited tag on a given object by [manually setting](work.html#label-object-tagging-set) the tag on
...
[automatic propagation](propagation).

The value of an inherited tag is overwritten by [sensitive data classification](../classify-intro).
