...
already [configured your IdP to work with Snowflake](admin-security-fed-auth-configure-idp).

Note

A SAML2 security integration replaces the deprecated [SAML\_IDENTITY\_PROVIDER](../sql-reference/parameters.html#label-saml-identity-provider) account parameter.
...
integration](admin-security-fed-auth-configure-snowflake) before continuing to configure Snowflake for federated
authentication.
...
* When you [configured an IdP](admin-security-fed-auth-configure-idp) for SSO, you provided a URL for the Snowflake
  account. The [format](organizations-connect.html#label-connecting-via-url) of this URL must match the URLs in the `SAML2_SNOWFLAKE_ISSUER_URL` and
  ...
  [legacy URL](admin-account-identifier.html#label-account-locator) of the account.
...
You can [use a SAML2 security integration with Client Redirect](account-replication-security-integrations.html#label-account-replication-security-integration-saml2) if your
account is a [Business Critical Edition or higher](replication-intro).

For more information, see [Redirecting client connections](client-redirect).
...
[Using SSO with client applications that connect to Snowflake](admin-security-fed-auth-use.html#label-sso-with-command-line-clients)
...
[SAML2\_SIGN\_REQUEST](../sql-reference/sql/create-security-integration-saml2.html#label-parameter-sql-reference-optional-parameters) property.
...
[SAML2\_SNOWFLAKE\_X509\_CERT](../sql-reference/sql/create-security-integration-saml2.html#label-parameter-sql-reference-optional-parameters) property. Your IdP uses this certificate to verify
...
1. Execute the [DESCRIBE INTEGRATION](../sql-reference/sql/desc-integration) command:
   ...
   >
   > Scroll to top
2. Save the value of the [SAML2\_SNOWFLAKE\_X509\_CERT](../sql-reference/sql/create-security-integration-saml2.html#label-parameter-sql-reference-optional-parameters) property in row 7 to use in
   your IdP settings.
...
If you are [creating a SAML2 security integration](#label-saml-sso-create-integration) for the first time, ensure you set the
[SAML2\_REQUESTED\_NAMEID\_FORMAT](../sql-reference/sql/create-security-integration-saml2.html#label-parameter-sql-reference-optional-parameters) property.
...
If you are [creating a SAML2 security integration](#label-saml-sso-create-integration) for the first time, ensure you set the
[SAML2\_FORCE\_AUTHN](../sql-reference/sql/create-security-integration-saml2.html#label-parameter-sql-reference-optional-parameters) property.
...
This behavior does not apply to [Snowsight](ui-snowsight-gs.html#label-snowsight-getting-started-sign-in).
...
If you are [creating a SAML2 security integration](#label-saml-sso-create-integration) for the first time, ensure you set the
[SAML2\_POST\_LOGOUT\_REDIRECT\_URL](../sql-reference/sql/create-security-integration-saml2.html#label-parameter-sql-reference-optional-parameters) property.
...
For details, see [Replication of security integrations & network policies across multiple accounts](account-replication-security-integrations).
