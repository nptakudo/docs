...
url: "https://docs.snowflake.com/en/user-guide/data-engineering/dbt-projects-on-snowflake-monitoring-observability"
---
...
2. From the list, select the schedule (task) that you want to inspect, and then choose View details.
   ...
   The information pane for the task opens, where you can view Task details, the task Graph (if applicable), and Run history of this task. For more information, see [View tasks and task graphs in Snowsight](../ui-snowsight-tasks).
...
For more information, see [Access control for dbt projects on Snowflake](dbt-projects-on-snowflake-access-control).
