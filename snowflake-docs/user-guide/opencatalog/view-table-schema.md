...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/view-table-schema"
---
...
6. If the data type for the **Type** column in the schema is **struct** or **list<struct >**, to view the nested schema for the column, select **View nested schema** ![Screenshot that shows the Accounts page in Snowsight.](../../_images/view-nested-schema-icon.png).
