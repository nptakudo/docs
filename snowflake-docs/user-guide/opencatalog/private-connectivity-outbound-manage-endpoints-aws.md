...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/private-connectivity-outbound-manage-endpoints-aws"
---
...
Follow the instructions in [Create a catalog using Amazon Simple Storage Service (Amazon S3)](create-catalog.html#create-a-catalog-using-amazon-simple-storage-service-amazon-s3).
