...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/access-control"
---
...
![Diagram that shows the RBAC model for Open Catalog.](../../_images/rbac-model.svg)
...
![Diagram that shows the RBAC model for Open Catalog at table, namespace level.](../../_images/rbac-model-namespace-table.svg)
...
![Diagram that shows an example of how RBAC works in Open Catalog.](../../_images/rbac-example.svg)
