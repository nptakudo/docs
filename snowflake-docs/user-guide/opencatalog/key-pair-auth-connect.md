...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/key-pair-auth-connect"
---
...
| `<access_token>` | Specifies the access token for the client application to use.   Enter the [access token that you generated when you configured key pair authentication in Open Catalog](key-pair-auth-configure.html#step-6-generate-an-access-token-for-the-user). |
...
see [List namespaces](spark-code-examples.html#list-namespaces).
