...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/key-pair-auth-configure"
---
...
with privileges. For more information about custom roles, see [Custom role](access-control.html#custom-role). For more information on the
RBAC model in Open Catalog, see [RBAC model](access-control.html#rbac-model).
...
1. [Generate a private and public key](#id3)
