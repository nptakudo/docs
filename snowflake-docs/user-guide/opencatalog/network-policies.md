...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/network-policies"
---
...
![Screenshot of an example network policy in Open Catalog that uses CIDR notation.](../../_images/network-policy-example-cidr-notation.png)
