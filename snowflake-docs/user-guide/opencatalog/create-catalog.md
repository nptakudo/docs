...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/create-catalog"
---
...
3. In the **Create Catalog** dialog, complete the fields:
   ...
   2. Optional: To create an external catalog, set the **External** toggle to **On**.
      ...
      [Catalog types](overview.html#catalog-types).
...
7. Modify the policy document with the catalog storage details that you recorded:
   ...
   **Example policy document for IAM role**
   ...
   ![Update the trust policy for the IAM role.](../../_images/iam-edit-trust-policy.png)
...
3. In the **Create Catalog** dialog, complete the fields:
   ...
   2. Optional: To create an external catalog, set the **External** toggle to **On**.
      ...
      For information about external catalogs, see [Catalog types](overview.html#catalog-types).
