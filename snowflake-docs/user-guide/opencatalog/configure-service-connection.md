...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/configure-service-connection"
---
...
for one or multiple query engines. For more information about service connections, see [Service connection](overview.html#service-connection).

When you configure a new service connection, you specify the following items:

* A [principal role](access-control.html#principal-role) to grant to the service principal. You can use a principal role to logically
  group Open Catalog service principals together. For more information, including examples of principal roles, see [Principal role](access-control.html#principal-role).
...
4. In the Configure Service Connection dialog, complete the fields:
   ...
   2. For **Name**, enter a service principal name.
      ...
      use in tools. For more information, including examples, see [Service principal](overview.html#service-principal).
