...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/find-account-name"
---
...
2. To open the user menu, select your username on the bottom-left corner of the page. In the user menu, under Account, note the account name
   ...
   ![Screenshot that shows the user menu in Snowflake Open Catalog with the account name is highlighted.](../../_images/account-name.png)
