...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/create-catalog-role"
---
...
Create a catalog role to grant privileges on it when you [secure a catalog](secure-catalogs). For more information about catalog roles, see [Catalog role](access-control.html#catalog-role).
