...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/try-open-catalog-for-free"
---
...
When your trial period ends, you can [retain access to your Open Catalog account](#retain-access-to-your-open-catalog-account) by signing up
for Snowflake. Also, you can [drop your Open Catalog account](#drop-your-open-catalog-account) at any time.
...
2. From your Snowflake trial account, create an Open Catalog account. For details,
   see [create a Snowflake Open Catalog account](create-open-catalog-account).

## Sign in to an Open Catalog account

See [Sign in to Snowflake Open Catalog](signin-snowflake-customer).
