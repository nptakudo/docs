...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/sso-overview"
---
...
The steps for configuring any other SAML-based IdP are similar to [configuring Auth0](sso-configure-idp.html#configure-auth0) or
[configuring Okta](sso-configure-idp.html#configure-okta).
...
You can only use one SAML integration at a time. To see which one is enabled, see [Verify the security integration](sso-configure-open-catalog.html#verify-the-security-integration).
