...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/external-oauth-configure"
---
...
* To find your *Snowflake* organization name (`<orgname>`), see [Finding the organization and account name for an account](../admin-account-identifier.html#label-account-name-find).
* To find your *Snowflake Open Catalog* account name (`<my-snowflake-open-catalog-account-name>`), see
  [Find the account name for a Snowflake Open Catalog account](find-account-name).
...
* [Add a connection](../../developer-guide/snowflake-cli/connecting/configure-connections.html#label-snowcli-snow-connection-command-add)
...
[Set the default connection](../../developer-guide/snowflake-cli/connecting/configure-connections.html#label-cli-set-default-connection).
...
service principal with privileges. For more information about custom roles, see [Custom role](access-control.html#custom-role). For more
information on the RBAC model in Open Catalog, see [RBAC model](access-control.html#rbac-model).
...
see [RBAC model](access-control.html#rbac-model).
...
* If you want to grant a service principal with catalog admin privileges to a catalog,
  [grant a catalog role with catalog admin privileges to the custom role](#grant-a-catalog-role-with-catalog-admin-privileges-to-the-custom-role). For information on what privileges a catalog admin has, see [Catalog admin role](access-control.html#catalog-admin-role).
...
See See [Create a catalog role](create-catalog-role).
...
See [Grant catalog privileges on a catalog role](secure-catalogs.html#label-grant-catalog-privileges-catalog-role) and select the
...
See [Secure catalogs](secure-catalogs). These
...
In this section, you create a catalog role. For more information about catalog roles, see [Catalog role](access-control.html#catalog-role).
...
See [Create a catalog role](create-catalog-role).
...
See [Grant catalog privileges on a catalog role](secure-catalogs.html#label-grant-catalog-privileges-catalog-role).
...
See [Grant namespace privileges on a catalog role](secure-catalogs.html#label-grant-namespace-privileges-catalog-role).
...
See [Grant table privileges on a catalog role](secure-catalogs.html#label-grant-table-privileges-catalog-role).
...
the custom role. For more information on the RBAC model in Open Catalog, see [RBAC model](access-control.html#rbac-model).
...
Alternatively, you can skip this step and later, [connect with Open Catalog by using an automatic refresh token](external-oauth-connect.html#connect-with-open-catalog-by-using-automatic-refresh-token-preferred-method), which is the preferred method.
