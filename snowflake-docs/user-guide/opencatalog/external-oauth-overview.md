...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/external-oauth-overview"
---
...
![Diagram that shows the general workflow of External OAuth in Snowflake Open Catalog.](../../_images/external-oauth-general-workflow.svg)
