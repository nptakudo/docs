...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/enable-credential-vending-external-catalog"
---
...
[Credential vending for external catalogs](overview.html#credential-vending-for-external-catalogs).
...
4. On the **Catalog Details** tab, under Storage details, under Credential Vending, select the **Edit** icon.
   ...
   ![Screenshot that shows the Edit icon for enabling or disabling credential vending.](../../_images/edit-icon-disable-credential-vending.png)
...
4. [Secure the target catalog](secure-catalogs.html#secure-a-catalog). When securing it, ensure the catalog role has at least one of the following privileges granted to it:
