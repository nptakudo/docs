...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/secure-catalogs"
---
...
To grant privileges on a catalog, you first grant privileges on a catalog role. These privileges specify a set of permissions for actions that a service principal can take on the catalog. For more information about catalog roles, see [Catalog role](access-control.html#catalog-role).
...
6. In the **Grant new privileges on** dialog, complete the fields:
   ...
   2. For **Privileges**, select each privilege to grant on the catalog.
      ...
      For a description of the available privileges, see [Access control privileges for a catalog](access-control.html#catalog-privileges).
...
To bestow a catalog role’s privileges to the service principals that a principal role is granted to, grant the catalog role to that principal role. For more information about principal roles and service principals, see [Principal role](access-control.html#principal-role) and [Service principal](overview.html#service-principal).
...
6. In the **Grant new privileges on** dialog, complete the fields:
   ...
   2. For **Privileges**, select each privilege to grant on the namespace.
      ...
      For a description of the available privileges, see [Access control privileges for a namespace](access-control.html#namespace-privileges).
   3. Select **Grant privileges**.
...
To grant privileges on a table, you first grant privileges on a catalog role. These privileges specify a set of permissions for actions that a service principal can take on the table. For more information about catalog roles, see [Catalog role](access-control.html#catalog-role).
...
6. In the **Grant new privileges on** dialog, complete the fields:
   ...
   2. For **Privileges**, select each privilege to grant on the namespace.
      ...
      For a description of the available privileges, see [access control privileges for a table](access-control.html#table-privileges).
   3. Select **Grant privileges**.
