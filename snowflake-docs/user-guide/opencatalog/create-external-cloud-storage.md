...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/create-external-cloud-storage"
---
...
10. On the **Bucket details** page, next to the name of the folder you created, select **Copy**, and store the path for later use.
    ...
    ![Screenshot that shows the Copy icon in the Google Cloud Console.](../../_images/gcp-copy-icon.png)
