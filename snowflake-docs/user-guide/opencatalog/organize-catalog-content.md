...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/organize-catalog-content"
---
...
For more information about internal and external catalogs, see [Catalog types](overview.html#catalog-types).
