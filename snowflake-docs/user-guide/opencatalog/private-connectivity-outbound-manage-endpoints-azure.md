...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/private-connectivity-outbound-manage-endpoints-azure"
---
...
Follow the instructions in [Create a catalog using Azure storage](create-catalog.html#create-a-catalog-using-azure-storage).
