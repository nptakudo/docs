...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/release-notes"
---
...
* [Sign in to Open Catalog using private connectivity](signin-snowflake-customer.html#using-private-connectivity)
...
[Create a namespace](organize-catalog-content.html#create-a-namespace).
