...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/private-connectivity-inbound-configure-azure"
---
...
* Optional: To retrieve these values in JSON format, [Create a Snowflake CLI connection for Open Catalog](private-connectivity-outbound-manage-endpoints-aws.html#step-1-create-a-snowflake-cli-connection-for-open-catalog),
...
2. In the Azure portal, search for **Private Link**, and then select **Private Link** in the results.
   ...
   ![Conceptual diagram of Open Catalog.](../../_images/private-connectivity-inbound-azure-privatelink-preview.png)
3. Click **Private endpoints**, and then click **Add**.

   ![Conceptual diagram of Open Catalog.](../../_images/private-connectivity-inbound-azure-privatelink-endpoint.png)
...
2. Select the Network Interface result.
   ...
   ![Conceptual diagram of Open Catalog.](../../_images/private-connectivity-inbound-azure-privatelink-dns-endpoint.png)
3. Copy the value for the **Private IP address**.

   ![Conceptual diagram of Open Catalog.](../../_images/private-connectivity-inbound-azure-privatelink-dns-private-ip.png)
...
For an example, see [Example: Catalog integration that uses a private IP address](../tables-iceberg-open-catalog-query.html#label-example-catalog-integration-private-ip-address) in the Snowflake documentation.
