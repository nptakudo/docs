...
url: "https://docs.snowflake.com/en/user-guide/opencatalog/manage-users"
---
...
* Grant and revoke user roles. For more information about user roles, see [User roles](access-control.html#user-roles).
