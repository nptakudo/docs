...
url: "https://docs.snowflake.com/en/user-guide/data-load-snowpipe-errors-azure"
---
...
See [Creating a notification integration to send notifications to a Microsoft Azure Event Grid topic](notifications/creating-notification-integration-azure-event-grid).
...
`ERROR_INTEGRATION = <integration_name>`
:   Name of the notification integration you created in [Create notification integration in Snowflake](notifications/creating-notification-integration-azure-event-grid.html#label-notification-integration-azure-creating-integration).
...
[Create notification integration in Snowflake](notifications/creating-notification-integration-azure-event-grid.html#label-notification-integration-azure-creating-integration).
