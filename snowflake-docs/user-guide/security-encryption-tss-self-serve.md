...
url: "https://docs.snowflake.com/en/user-guide/security-encryption-tss-self-serve"
---
...
for your account, you should carefully consider your responsibility for safeguarding your key as mentioned in [Customer-managed keys](security-encryption-manage.html#label-customer-managed-keys).
...
will be enabled. For information, see [Hybrid Tables Dedicated Storage Mode for TSS](tables-hybrid-dedicated-storage-mode).
...
To enable private connectivity for a CMK already activated with Tri-Secret Secure, see [Enable a private connectivity endpoint for an active CMK](security-encryption-tss-self-serve-private.html#label-tss-enable-pl-for-active-cmk).
...
For more information, see [Customer-managed keys](security-encryption-manage.html#label-customer-managed-keys).
