...
>
>   Scroll to top
> * Add the FILES or PATTERN options (see [Options for selecting staged data files](data-load-considerations-load.html#label-options-for-selecting-staged-data-files)), e.g.:
>
>   > CopyExpand
>   >
>   > ```
