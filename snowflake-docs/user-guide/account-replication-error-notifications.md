...
:   The email notification integration must have at least one verified email address in the DEFAULT\_RECIPIENTS list.
    ...
    [Specify a default list of recipients and a default subject line](notifications/email-notifications.html#label-create-notification-integration-email-default-addresses).
...
:   You can use a notification integration that is configured to push notifications to a messaging service for any of the
    ...
    For more information, see [Sending notifications to cloud provider queues (Amazon SNS, Google Cloud PubSub, and Azure Event Grid)](notifications/queue-notifications).
...
:   You can use a notification integration that is configured to push notifications to a webhook for any of the external systems
    ...
    For more information, see [Sending webhook notifications](notifications/webhook-notifications).
