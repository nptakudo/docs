...
url: "https://docs.snowflake.com/en/user-guide/egress-ip/network-egress"
---
...
* [Snowpark Container Services external access](../../developer-guide/snowpark-container-services/service-network-communications.html#label-working-with-services-jobs-egress) and Snowflake Openflow on Snowpark Container Services
...
with fresh egress IP addressess, as described in [Automate IP address range refreshes](#label-network-egress-refreshing).
