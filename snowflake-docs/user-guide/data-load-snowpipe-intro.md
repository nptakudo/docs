...
For more information, see [Automate continuous data loading with cloud messaging](data-load-snowpipe-auto) and [Overview of the Snowpipe REST endpoints to load data](data-load-snowpipe-rest-overview).
