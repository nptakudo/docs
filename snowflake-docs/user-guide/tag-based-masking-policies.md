...
:   Tag-based policies allow policy administrators to write a policy once, assign a policy to a tag once, and, depending on the
    [level](object-tagging/inheritance.html#label-object-tagging-lineage) at which the tag is set, have the policy apply to many objects. This results in the vast
...
:   Tag-based masking policies offer an alternative to specifying the masking policy in a [CREATE TABLE](../sql-reference/sql/create-table) statement,
    ...
    assigning the policy to the tag, which uses [tag inheritance](object-tagging/inheritance.html#label-object-tagging-lineage).
...
* Regarding replication and tag-based masking policies, see
  [policy replication considerations](database-replication-considerations.html#label-database-replication-considerations-masking-row-policies).
* For details about [Secure Data Sharing](data-sharing-gs) and this feature, see:

  + [Masking Policies & Data Sharing](security-column-intro.html#label-security-column-intro-data-sharing)
  + [Object Tagging & Data Sharing](object-tagging/interaction.html#label-object-tagging-data-sharing)

## Limitations

All of the existing [masking policy limitations](security-column-intro.html#label-security-column-limitations) apply to tag-based masking policies.
...
System tags:
:   A masking policy cannot be assigned to a [system tag](classify-intro.html#label-classify-classification-tags).
...
:   A materialized view cannot be created if the underlying table is protected by a tag-based masking policy. For additional details,
    see [masking policies and materialized views](security-column-intro.html#label-security-column-intro-mv).
...
:   The role must have both the global APPLY MASKING POLICY and the global APPLY TAG privileges. For example, grant these privileges to the
    ...
    This is the most [centralized approach](object-tagging/work.html#label-object-tags-ddl-privilege-summary) to protect columns with a tag-based masking policy
...
* [Managing Column-level Security](security-column-intro.html#label-security-column-manage)
* [Access control privileges](object-tagging/work.html#label-object-tags-privileges)
...
A [conditional masking policy](security-column-intro.html#label-security-column-intro-cond-cols) can be assigned to a tag. After assigning the tag to a column,
...
protected, based on the current [limitations](security-column-intro.html#label-security-column-limitations),
[considerations](security-column-intro.html#label-security-column-considerations), and [behaviors](security-column-intro.html#label-security-column-intro-tables-views) regarding
...
* [Monitor tags with Snowsight](object-tagging/monitor.html#label-object-tagging-snowsight)
* [Monitor masking policies with Snowsight](security-column-intro.html#label-security-column-intro-snowsight)
...
`ACTIVE`
:   Specifies that the column (i.e. REF\_COLUMN\_NAME) is only associated with a single policy by a tag.
...
* The `tag_admin` custom role has the following privileges:
  ...
  For more information, see [tag privileges](object-tagging/work.html#label-object-tags-ddl-privilege-summary).
* The `masking_admin` custom role has the following privileges:
  ...
  For details, see, [tag privileges](object-tagging/work.html#label-object-tags-ddl-privilege-summary).
* The `row_access_admin` custom role has the following privileges:
  ...
  For more information, see [row access policy privileges](security-row-intro.html#label-security-row-privilege-command-summary).
...
* The custom roles described above are granted to the appropriate users.
  ...
  For details, see [Configuring access control](security-access-control-configure).
...
[tag inheritance](object-tagging/inheritance.html#label-object-tagging-lineage).
