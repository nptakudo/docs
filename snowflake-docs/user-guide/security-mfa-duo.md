...
url: "https://docs.snowflake.com/en/user-guide/security-mfa-duo"
---
...
authentication, see [Configuring a second factor of authentication](security-mfa-second-factor).
...
as their second factor of authentication. For other options, see [Configuring a second factor of authentication](security-mfa-second-factor).
...
information, see [Recovering a user who is locked out](security-mfa.html#label-mfa-recovery).
