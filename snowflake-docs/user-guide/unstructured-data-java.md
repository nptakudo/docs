...
[Introduction to unstructured data](unstructured-intro).
...
1. Paste and run the following code to create a UDF.
   ...
   For more on reading files with `InputStream`, refer to [Reading a dynamically-specified file with InputStream](../developer-guide/udf/java/udf-java-cookbook.html#label-reading-file-from-java-udf-inputstream).
...
1. Paste and run the following code to create a procedure.
   ...
   file. For more on reading files with `SnowflakeFile`, refer to [Reading a dynamically-specified file with SnowflakeFile](../developer-guide/stored-procedure/java/procedure-java-read-files.html#label-reading-file-snowflakefile-java).
