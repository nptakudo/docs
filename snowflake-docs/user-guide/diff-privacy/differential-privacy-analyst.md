...
* Differential privacy supports a subset of Snowflake data types, operators, query syntax, and functions. For a list of supported SQL that
  you can use in a query, see [Differential privacy SQL reference](differential-privacy-sql-reference).
...
[privacy domain](differential-privacy-privacy-domains).

For a list of supported aggregations, see [Aggregate functions](differential-privacy-sql-reference.html#label-diff-privacy-sql-support-aggregate).
...
[Privacy domains and joins](differential-privacy-privacy-domains.html#label-diff-privacy-privacy-domains-joins).
...
syntax, see [Implementing joins](../querying-joins.html#label-querying-join-implement).
...
For information about the supported query syntax related to joins, see [Query syntax](differential-privacy-sql-reference.html#label-diff-privacy-sql-support-syntax).

#### Using entity keys in joins

When working with tables protected with [entity-level privacy](differential-privacy-admin.html#label-diff-privacy-admin-entity-privacy), you can minimize the amount
...
of a column includes whether or not it has a [privacy domain](differential-privacy-privacy-domains).
...
For information on how to set a privacy domain for a table, see [Setting a privacy domain](differential-privacy-privacy-domains-admin.html#label-diff-privacy-admin-privacy-domains-create).
...
The uniqueness requirement for joins doesn’t always apply to queries against tables that are protected by [entity-level privacy](differential-privacy-admin.html#label-diff-privacy-admin-entity-privacy). For entity-level privacy, queries must de-duplicate on the entity key before the aggregation.
...
Most data providers use an entity key to implement [entity-level privacy](differential-privacy-admin.html#label-diff-privacy-admin-entity-privacy) when configuring
...
* The WHERE clause on the outer query is required in order to
  [specify a privacy domain on the data](differential-privacy-privacy-domains-analyst).
...
[noise](differential-privacy-overview.html#label-diff-privacy-noisy-aggregates) into the result so it becomes an approximation of the actual value. The returned value
...
* [Narrowing a privacy domain to improve results](differential-privacy-privacy-domains-analyst.html#label-diff-privacy-analyst-privacy-domains-improve-results)
* [Using entity keys in joins](#label-diff-privacy-joins-entity-keys)
