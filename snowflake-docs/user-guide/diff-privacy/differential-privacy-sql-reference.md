...
url: "https://docs.snowflake.com/en/user-guide/diff-privacy/differential-privacy-sql-reference"
---
...
| SELECT ALL |  |
| FROM |  |
| INNER JOIN ON | See [Supported joins](differential-privacy-analyst.html#label-diff-privacy-joins-supported). |
| INNER JOIN USING | See [Supported joins](differential-privacy-analyst.html#label-diff-privacy-joins-supported). |
| LEFT OUTER JOIN ON | See [Supported joins](differential-privacy-analyst.html#label-diff-privacy-joins-supported). |
| LEFT OUTER JOIN USING | See [Supported joins](differential-privacy-analyst.html#label-diff-privacy-joins-supported). |
| RIGHT OUTER JOIN ON | See [Supported joins](differential-privacy-analyst.html#label-diff-privacy-joins-supported). |
| RIGHT OUTER JOIN USING | See [Supported joins](differential-privacy-analyst.html#label-diff-privacy-joins-supported). |
| FULL OUTER JOIN ON | See [Supported joins](differential-privacy-analyst.html#label-diff-privacy-joins-supported). |
| FULL OUTER JOIN USING | See [Supported joins](differential-privacy-analyst.html#label-diff-privacy-joins-supported). |
| NATURAL JOIN | See [Supported joins](differential-privacy-analyst.html#label-diff-privacy-joins-supported). |
| WHERE |  |
