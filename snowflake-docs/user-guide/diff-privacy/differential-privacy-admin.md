...
* [Privacy policies](differential-privacy-admin-privacy-policies). A table or view is not protected by
  differential privacy until you assign a privacy policy to it. A table or view with a privacy policy is considered to be
  *privacy-protected*.
* [Privacy budgets](differential-privacy-overview.html#label-diff-privacy-loss-budgets). As analysts query a privacy-protected table, you can
  [manage the privacy budgets](differential-privacy-admin-privacy-budgets) associated with those analysts.
* [Privacy domains](differential-privacy-privacy-domains). You should define a privacy domain for fact and
...
* Apart from querying the [noise interval](differential-privacy-analyst.html#label-diff-privacy-understand-results), analysts don’t know whether they’re querying a
...
* The table will not be used in a join. Joins with tables protected by row-level privacy are possible, but have
  [limitations](differential-privacy-analyst.html#label-diff-privacy-joins-no-duplicates).
...
see [Assign a privacy policy](differential-privacy-admin-privacy-policies.html#label-diff-privacy-admin-assign). If you choose to implement entity-level privacy, the data must also meet
...
[Privacy policies](../account-replication-considerations.html#label-account-replication-considerations-privacy-policy).
...
For the effects of cloning privacy-protected tables and views, see [Cloning and differential privacy](../object-clone.html#label-cloning-consideration-diff-privacy).
