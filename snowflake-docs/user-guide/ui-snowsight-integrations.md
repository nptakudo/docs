...
url: "https://docs.snowflake.com/en/user-guide/ui-snowsight-integrations"
---
...
* [Catalog integrations](../sql-reference/sql/create-catalog-integration) supporting integrating [Apache Iceberg™ tables](tables-iceberg).
