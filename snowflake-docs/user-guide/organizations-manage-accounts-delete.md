...
url: "https://docs.snowflake.com/en/user-guide/organizations-manage-accounts-delete"
---
...
[rename the account](organizations-manage-accounts-rename) before dropping it.
...
The grace period is not the same as the data retention period of [Time Travel](data-time-travel).
...
[As the organization administrator](organization-administrators), you can drop an account using [Snowsight](ui-snowsight-gs.html#label-snowsight-getting-started-sign-in) or
SQL.
...
Snowsight:
:   [As the organization administrator](organization-administrators), you can use Snowsight to view all dropped
...
:   Executing the [SHOW ACCOUNTS](../sql-reference/sql/show-accounts) command with the optional HISTORY keyword shows dropped accounts
    ...
    When the [organization administrator](organization-administrators) executes the following command:
...
[As the organization administrator](organization-administrators), you can undrop an account using Snowsight or
SQL.
