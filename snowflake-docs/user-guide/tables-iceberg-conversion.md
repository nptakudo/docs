...
Convert an [Apache Iceberg™ table](tables-iceberg) that Snowflake doesn’t manage into a
...
including support for the [Snowflake Catalog SDK](tables-iceberg-catalog).

To learn about the differences between Iceberg table types, see [Catalog options](tables-iceberg.html#label-tables-iceberg-catalog-options).
...
source data type supports. For more information, see [Approximate types](tables-iceberg-data-types.html#label-tables-iceberg-approximate-types).
