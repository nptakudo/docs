...
url: "https://docs.snowflake.com/en/user-guide/tables-external-auto"
---
...
* [Refresh external tables automatically for Amazon S3](tables-external-s3)
* [Refresh external tables automatically for Google Cloud Storage](tables-external-gcs)
* [Refresh external tables automatically for Azure Blob Storage](tables-external-azure)
