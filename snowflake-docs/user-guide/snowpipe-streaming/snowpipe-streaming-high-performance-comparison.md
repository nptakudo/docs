...
url: "https://docs.snowflake.com/en/user-guide/snowpipe-streaming/snowpipe-streaming-high-performance-comparison"
---
...
* **Schema evolution support**: The high-performance SDK supports [schema evolution](../data-load-schema-evolution), a key capability for handling changing data schemas automatically.
