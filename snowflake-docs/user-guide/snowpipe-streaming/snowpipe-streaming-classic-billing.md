...
url: "https://docs.snowflake.com/en/user-guide/snowpipe-streaming/snowpipe-streaming-classic-billing"
---
...
For more information about querying the total Snowpipe Streaming costs, see [a SQL example](../cost-exploring-compute.html#label-cost-explore-query-snowpipe-streaming).
