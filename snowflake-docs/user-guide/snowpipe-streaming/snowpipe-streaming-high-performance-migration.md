...
url: "https://docs.snowflake.com/en/user-guide/snowpipe-streaming/snowpipe-streaming-high-performance-migration"
---
...
The following table summarizes the most important architectural changes in the high-performance Snowpipe Streaming SDK. For a detailed comparison of the SDKs, see [Comparison between Snowpipe Streaming high-performance and classic SDKs](snowpipe-streaming-high-performance-comparison).
...
4. Update your application code.
   ...
   * Update your API calls as detailed in the following [API and configuration changes](#api-configuration-changes) section.
