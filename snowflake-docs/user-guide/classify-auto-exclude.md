...
url: "https://docs.snowflake.com/en/user-guide/classify-auto-exclude"
---
...
An [object tag](object-tagging/introduction) is an object that can be set on another object. Snowflake
...
5. Do one of the following:
   ...
   * If you are enabling the setting for an existing classification profile, find the profile and select [![Three vertical dots indicating more options](../_images/vertical-more-icon.png)](../_images/vertical-more-icon.png) » Edit.
...
settings are specified using key-value pairs in an [OBJECT](../sql-reference/data-types-semistructured.html#label-data-type-object).
