...
url: "https://docs.snowflake.com/en/user-guide/hostname-allowlist"
---
...
[secure/private network](admin-security-privatelink), you must allow the host names for the required hosts.
...
Use [SnowCD](snowcd) to ensure the provided endpoints are allowed.
