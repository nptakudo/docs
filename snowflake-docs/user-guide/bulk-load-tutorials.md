...
url: "https://docs.snowflake.com/en/user-guide/bulk-load-tutorials"
---
...
[Bulk load from a local file system using COPY](tutorials/data-load-internal-tutorial)
:   Describes how to [bulk load data](data-load-local-file-system) from files in your
    local file system into a table.

[Bulk load from Amazon S3 using COPY](tutorials/data-load-external-tutorial)
