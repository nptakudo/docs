...
* Loaded into a table, along with the regular data columns, using [COPY INTO <table>](../sql-reference/sql/copy-into-table). For general information about querying staged data files, see [Query data in staged files](querying-stage).
...
For more information about transforming data using a COPY statement, see [Transform data during a load](data-load-transform).
