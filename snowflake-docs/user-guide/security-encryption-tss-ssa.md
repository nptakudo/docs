...
url: "https://docs.snowflake.com/en/user-guide/security-encryption-tss-ssa"
---
...
safeguarding your key, as described in [Customer-managed keys](security-encryption-manage.html#label-customer-managed-keys). If the customer-managed key (CMK) in the composite master key
...
To activate Tri-Secret Secure for an SSA account, complete the following steps. These steps assume that you already [registered your CMK](security-encryption-tss.html#label-self-register-a-cmk).
