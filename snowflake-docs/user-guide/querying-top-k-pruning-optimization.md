...
* The first column specified in the ORDER BY clause has one of the following data types:
  ...
  + An integer-representable data type (that is, an [INTEGER type](../sql-reference/data-types-numeric.html#label-data-type-integer), a [DATE type](../sql-reference/data-types-datetime.html#label-datatypes-date),
    or a [TIMESTAMP type](../sql-reference/data-types-datetime.html#label-datatypes-timestamp)). Expressions that return integers, such as casts, are not supported.
