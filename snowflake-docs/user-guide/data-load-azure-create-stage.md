...
integration that was created in [Configure an Azure container for loading data](data-load-azure-config) to access the Azure container `container1` in the `myaccount`
account.
...
**Next:** [Copy data from an Azure stage](data-load-azure-copy)
