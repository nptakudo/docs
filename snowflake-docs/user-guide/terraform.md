...
url: "https://docs.snowflake.com/en/user-guide/terraform"
---

# Snowflake Terraform provider

[![Snowflake logo in black (no text)](../_images/logo-snowflake-black.png)](../_images/logo-snowflake-black.png) Snowflake Terraform Provider — Generally Available

The Snowflake Terraform provider is not supported in Microsoft Azure Government regions.
