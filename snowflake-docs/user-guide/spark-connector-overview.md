...
![Snowflake as a data source for Spark](../_images/spark-snowflake-data-source.png)
...
[Enforce data protection policies when querying Apache Iceberg™ tables from Apache Spark™](tables-iceberg-query-using-external-query-engine-snowflake-horizon-enforce-access-policies).
...
![Interaction between Snowflake and Spark](../_images/spark-snowflake-interaction.png)
...
The parameter(s) to specify the storage location are documented in [Setting Configuration Options for the Connector](spark-connector-use.html#label-spark-options):
...
documented in [Setting Configuration Options for the Connector](spark-connector-use.html#label-spark-options).
...
[Pushdown](spark-connector-use.html#label-spark-pushdown) for the list of operations supported for pushdown.
...
(in the Databricks documentation) or [Configuring Snowflake for Spark in Databricks](spark-connector-databricks).
...
(in the Qubole Documentation) or [Configuring Snowflake for Spark in Qubole](spark-connector-qubole).
