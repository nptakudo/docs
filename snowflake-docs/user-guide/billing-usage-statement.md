...
url: "https://docs.snowflake.com/en/user-guide/billing-usage-statement"
---
...
* You cannot access usage statements from an account in [US SnowGov Regions](intro-regions.html#label-intro-regions-snowgov-regions) on AWS
