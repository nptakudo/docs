...
entity-level privacy. For general information about working with aggregation policies, see [Aggregation policies](aggregation-policies).
...
| --- | --- | --- | --- | --- |
| dave\_sr@example.com | 12345 | 1 | 29 | 2023-09-12 09:00 |
| mary@bazco.com | 23485 | 1 | 30 | 2023-09-12 09:00 |
| dave\_sr@example.com | 12345 | 6 | 18 | 2023-09-11 13:00 |
...
Note that the entity key is not always the same as the [primary key](../sql-reference/constraints-overview.html#label-constraints-supported-types) of a table. In this example,
...
restrictions under different circumstances, see [Create an aggregation policy](aggregation-policies.html#label-aggregation-policy-create).
...
[updating an existing table of view](#label-agg-entity-privacy-assign-existing).
...
information about what types of queries conform to these requirements, see [Query requirements](aggregation-policies.html#label-aggregation-policy-query-reqs).
