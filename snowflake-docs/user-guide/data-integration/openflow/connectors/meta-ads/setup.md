...
url: "https://docs.snowflake.com/en/user-guide/data-integration/openflow/connectors/meta-ads/setup"
---
...
1. Ensure that you have reviewed [About Openflow Connector for Meta Ads](about).
...
3. If using Openflow - Snowflake Deployments, ensure that you’ve reviewed [configuring required domains](../../setup-openflow-spcs-sf-allow-list)
   and have granted access to the required domains for the [Meta Ads](../../setup-openflow-spcs-sf-allow-list.html#label-openflow-domains-used-by-openflow-connectors-meta-ads) connector.
...
* [Meta Ads Source Parameters](#meta-ads-source-parameters): Used to establish connection with MetaAds API.
* [Meta Ads Destination Parameters](#meta-ads-destination-parameters): Used to establish connection with Snowflake.
* [Meta Ads Ingestion Parameters](#meta-ads-ingestion-parameters): Used to define the configuration of data downloaded from Meta Ads.
