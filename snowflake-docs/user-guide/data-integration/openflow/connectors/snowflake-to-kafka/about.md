...
url: "https://docs.snowflake.com/en/user-guide/data-integration/openflow/connectors/snowflake-to-kafka/about"
---
...
For more information, see [Stream columns](../../../../streams-intro.html#label-stream-metadata-columns).
...
[Set up the Openflow Connector for Snowflake to Kafka](setup)
