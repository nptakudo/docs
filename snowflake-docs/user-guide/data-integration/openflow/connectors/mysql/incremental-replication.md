...
url: "https://docs.snowflake.com/en/user-guide/data-integration/openflow/connectors/mysql/incremental-replication"
---
...
1. Setup the connector as described in [Set up the Openflow Connector for MySQL](setup).
