...
url: "https://docs.snowflake.com/en/user-guide/data-integration/openflow/connectors/google-drive/setup"
---
...
1. Ensure that you have reviewed [About Openflow Connector for Google Drive](about).
...
3. If using Openflow - Snowflake Deployments, ensure that you’ve reviewed [configuring required domains](../../setup-openflow-spcs-sf-allow-list)
   and have granted access to the required domains for the [Google Drive](../../setup-openflow-spcs-sf-allow-list.html#label-openflow-domains-used-by-openflow-connectors-google-drive) connector.
...
Run the following in a [SQL worksheet](../../../../ui-snowsight-worksheets-gs.html#label-snowsight-worksheets-create-file) to query the Cortex Search service with files ingested from Google Drive.
