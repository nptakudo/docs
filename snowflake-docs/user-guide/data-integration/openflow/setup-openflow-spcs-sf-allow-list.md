...
using [network rules](../../network-rules) and
...
1. Associate an external access integration with your runtime:
   ...
   3. For the runtime which requires the new external access integration,
      click the [![Vertical more icon](../../../_images/vertical-more-icon1.png)](../../../_images/vertical-more-icon1.png) menu.
...
2. Deploy a connector in a runtime, for a list of connectors available in Openflow, see [Openflow connectors](connectors/about-openflow-connectors).
