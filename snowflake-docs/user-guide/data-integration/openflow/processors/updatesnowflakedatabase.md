...
url: "https://docs.snowflake.com/en/user-guide/data-integration/openflow/processors/updatesnowflakedatabase"
---
...
| Removed Column Name Suffix | The suffix to append to a column that was removed. For example, to rename column ‘foo’ to ‘foo\_\_deleted’, the property can be set to `__deleted` |
