...
url: "https://docs.snowflake.com/en/user-guide/data-integration/openflow/monitor"
---
...
([BYOC](setup-openflow-byoc.html#label-openflow-event-table) | [Snowflake deployment](setup-openflow-spcs-deployment.html#label-openflow-spcs-event-table)).
...
types of resource attributes see [RESOURCE\_ATTRIBUTES column](../../../developer-guide/logging-tracing/event-table-columns.html#label-event-table-resource-attributes-column) in the Event Table columns documentation.
