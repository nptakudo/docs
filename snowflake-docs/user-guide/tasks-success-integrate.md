...
Name of the notification integration created in one of [AWS SNS](notifications/creating-notification-integration-amazon-sns), [Microsoft Azure Event Grid](notifications/creating-notification-integration-azure-event-grid), or [Google Pub/Sub](notifications/creating-notification-integration-google-pubsub) platform level notifications.
