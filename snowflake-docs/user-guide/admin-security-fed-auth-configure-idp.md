...
url: "https://docs.snowflake.com/en/user-guide/admin-security-fed-auth-configure-idp"
---
...
private connectivity to the Snowflake service. To learn more, see [Managing/Using federated authentication](admin-security-fed-auth-use).
...
3. Create a Snowflake application in Okta:
   ...
   * In the SubDomain field for the application, enter the [account identifier](admin-account-identifier) of
...
when you configure Snowflake, as described in [Configuring Snowflake to use federated authentication](admin-security-fed-auth-security-integration).
...
[configure Snowflake to use federated authentication](admin-security-fed-auth-security-integration) to complete your custom IdP setup.
