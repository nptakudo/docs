...
url: "https://docs.snowflake.com/en/user-guide/unstructured-ts"
---
...
staged files using a URL. For more information, see [Server-side encryption for unstructured data access](unstructured-intro.html#label-file-url-server-side-encryption).
