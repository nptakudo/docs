...
1. Sign in to [Snowsight](ui-snowsight-gs.html#label-snowsight-getting-started-sign-in) with the [necessary privileges](#label-lineage-privileges).
...
> ![Example screenshot of data lineage in Snowsight](../_images/data-lineage.png)
...
information about the privileges required to work with tags, see [Summary of DDL commands, operations, and privileges](object-tagging/work.html#label-object-tags-ddl-privilege-summary).
...
2. To view the masking policy on a column of the object, find the column in the Columns section. If the column is protected by a
   ...
   additional help identifying why the error might have occurred, see [Tag and policy discovery](tag-based-masking-policies.html#label-tag-based-masking-discovery) and
   [Troubleshoot tag-based masking policies](tag-based-masking-policies.html#label-tab-based-masking-troubleshoot).
...
* [CREATE TABLE … AS SELECT](../sql-reference/sql/create-table.html#label-ctas-syntax) (CTAS)
* [CREATE TABLE … CLONE](../sql-reference/sql/create-table.html#label-create-table-clone-syntax)
...
* [Feature Views](../developer-guide/snowflake-ml/feature-store/feature-views) (which are actually a dynamic tables or views inside Snowflake)
...
For more information, see [External lineage](external-lineage).
