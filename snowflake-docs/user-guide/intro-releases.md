...
url: "https://docs.snowflake.com/en/user-guide/intro-releases"
---
...
:   A full release may include any of the following:
    ...
    * Behavior changes (see next section in this topic)
    ...
    In addition, a full release includes updated Snowflake release notes documentation per weekly cycle. See [Snowflake server release notes and feature updates](../release-notes/new-features).
...
their [Snowflake Edition](intro-editions):
