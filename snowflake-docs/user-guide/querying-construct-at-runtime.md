...
For more information, see [SQL injection](../developer-guide/stored-procedure/stored-procedures-usage.html#label-sql-injection).
...
Note: If you use [Snowflake CLI](../developer-guide/snowflake-cli/index), [SnowSQL](snowsql), the Classic Console, or the
