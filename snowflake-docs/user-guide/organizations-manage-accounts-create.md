...
url: "https://docs.snowflake.com/en/user-guide/organizations-manage-accounts-create"
---

# Creating an account

[As the organization administrator](organization-administrators), you can create an account through the web interface or
using SQL:
...
When creating an account, you can specify a [cloud platform](intro-cloud-platforms), a
[region](intro-regions), and a [Snowflake edition](intro-editions). You can optionally specify a region
group if you have, or want to have, accounts in multiple region groups. For more details see [Region groups](admin-account-identifier.html#label-region-groups).
...
* You can only create an account in a region that is enabled for your organization. For a list of available regions,
  see [View a list of regions available for an organization](intro-regions.html#label-show-organization-regions). To request access to additional regions, contact [Snowflake Support](https://docs.snowflake.com/user-guide/contacting-support).
...
[ADMIN\_RSA\_PUBLIC\_KEY](../sql-reference/sql/create-account.html#label-create-account-admin-rsa-public-key) during account creation.
