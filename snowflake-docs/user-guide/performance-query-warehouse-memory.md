...
You can use the [Query Profile](ui-snowsight-activity.html#label-snowsight-query-profile) to identify which operation nodes are causing data to spill to storage.
For considerations for selecting the appropriate warehouse sizing, please refer to [Warehouse considerations](warehouses-considerations).
