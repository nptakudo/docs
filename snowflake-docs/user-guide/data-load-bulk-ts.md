...
It is recommended to include and query [METADATA$START\_SCAN\_TIME](querying-metadata) instead, which provides a more accurate representation of record loading.
