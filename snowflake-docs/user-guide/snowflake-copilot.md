...
For details, see [Switch your primary role](ui-snowsight-gs.html#label-switching-your-active-role).
...
For more information, see [Using SNOWFLAKE database roles](../sql-reference/snowflake-db-roles.html#label-using-snowflake-db-roles). A user with the ACCOUNTADMIN role can grant this role to a custom role
...
| --- | --- | --- |
| Usage Data | Usage Data | Generally available functions are Covered AI Features. Preview functions are Preview AI Features. [[1]](#id2) |
