...
url: "https://docs.snowflake.com/en/user-guide/classify-native"
---
...
To classify attributes that are not supported natively, refer to [Create custom categories for sensitive data](classify-custom).
...
process. For more information about viewing this response object, refer to [Use SQL to view results](classify-results.html#label-classify-view-results-sql).
...
| --- | --- |
| BANK\_ACCOUNT | For countries outside of Cananda, New Zealand, and the United States, the semantic subcategory is International Bank Account Number (IBAN). |
| EMAIL |  |
