...
url: "https://docs.snowflake.com/en/user-guide/tables-iceberg-open-catalog-query"
---
...
you can create an [externally managed](tables-iceberg.html#label-tables-iceberg-catalog-integration) Apache Iceberg™ table and a catalog integration.
...
use a [catalog-linked database](tables-iceberg-catalog-linked-database) to automatically discover multiple tables in Open Catalog.
...
* To find your Snowflake organization name (`<orgname>`), follow the steps in [Finding the organization and account name for an account](admin-account-identifier.html#label-account-name-find).
...
For more information, see [Automatically refresh Apache Iceberg™ tables](tables-iceberg-auto-refresh). If you didn’t specify a CATALOG\_NAMESPACE with the catalog integration
