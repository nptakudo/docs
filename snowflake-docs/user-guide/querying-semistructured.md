...
(For simple examples of how to extract values from ARRAYs and OBJECTs, see [Accessing elements of an array by index or by slice](../sql-reference/data-types-semistructured.html#label-accessing-array-by-index) and
[Accessing elements of an OBJECT value by key](../sql-reference/data-types-semistructured.html#label-accessing-object-by-key).)
...
value by calling [PARSE\_XML](../sql-reference/functions/parse_xml)), see [Examples of querying XML data](semistructured-data-formats.html#label-xml-examples-querying) and
[XMLGET](../sql-reference/functions/xmlget).

Tip

You can use the search optimization service to improve query performance.
For details, see [Search optimization service](search-optimization-service).
...
[VARIANT](../sql-reference/data-types-semistructured.html#label-data-type-variant) column named `src`. This VARIANT contains nested [ARRAYs](../sql-reference/data-types-semistructured.html#label-data-type-array)
and [OBJECTs](../sql-reference/data-types-semistructured.html#label-data-type-object).
...
For more information about casting VARIANT values, see [Inserting VARIANT data](../sql-reference/data-types-semistructured.html#label-using-values-in-a-variant).
...
the lambda function that operates on the data, which is specified in an [array](../sql-reference/data-types-semistructured.html#label-data-type-array).
...
You can execute an [uncorrelated scalar subquery](querying-subqueries) in a lambda
