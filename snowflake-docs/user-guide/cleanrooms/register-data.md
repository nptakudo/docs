...
1. [Sign in to the Clean rooms UI](web-app-introduction.html#label-cleanroom-web-app-sign-in) as an account administrator and then take one of the following
   steps:
...
command. Replace the database name and [clean room ID](developer-introduction.html#label-dcr-about-clean-room-names) placeholders with the appropriate values:
