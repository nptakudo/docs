...
url: "https://docs.snowflake.com/en/user-guide/cleanrooms/web-app-introduction"
---
...
Currently available in [these regions](#label-web-app-hosting).

Not available in government and VPS deployments.

The clean rooms UI provides a user interface to create, share, and use a
[Snowflake Data Clean Room](introduction), run queries, and more. The clean rooms UI allows non-technical
...
* **Network addresses used by clean rooms UI**: These are the network addresses used by the clean rooms UI to communicate with your
  Snowflake account. If your Snowflake account uses a [network policy](../network-policies) to control network traffic, your
...
After you sign in to the UI, see [Run an analysis in the UI](web-app-working) for information about
creating, sharing, and using a clean room. You can also use the Help Center in the clean room environment to guide you.

You can also complete a [tutorial](tutorials/cleanroom-web-app-tutorial) for help with getting started.
