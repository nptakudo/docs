...
url: "https://docs.snowflake.com/en/user-guide/cleanrooms/manage-clean-rooms"
---
...
[clean rooms UI tutorial](tutorials/cleanroom-web-app-tutorial)
...
[clean rooms code tutorial](tutorials/cleanroom-api-tutorial-basic)
...
> 1. [Sign in to the clean rooms UI.](web-app-introduction.html#label-cleanroom-web-app-sign-in)
> 2. In the left navigation, select Clean Rooms.
> 3. In the clean room to delete, select *More* ([![Three vertical dots indicating more options](../../_images/vertical-more-icon.png)](../../_images/vertical-more-icon.png)) > Delete.
...
4. In the clean room to uninstall, select *More* ([![Three vertical dots indicating more options](../../_images/vertical-more-icon.png)](../../_images/vertical-more-icon.png)) > Leave.
...
[Learn how to register or unregister data objects](register-data) to make them available for linking
into a clean room.
