...
url: "https://docs.snowflake.com/en/user-guide/cleanrooms/dcr-versions"
---
...
Clean rooms are versioned because they are implemented as [native application packages](../../developer-guide/native-apps/native-apps-about.html#label-components-of-the-naf). In
...
Updates are handled automatically by Snowflake [as available resources dictate](../../developer-guide/native-apps/update-app-overview.html#label-native-apps-upgrades-about), and there can be
