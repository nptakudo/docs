...
url: "https://docs.snowflake.com/en/user-guide/cleanrooms/manage-dcr-users"
---
...
collaborators in their account. For more information about RBAC, see [Overview of Access Control](../security-access-control-overview). To see which
...
* **MANAGE\_CLEANROOMS:** Application role that provides the ability to create, update, delete, and install cleanrooms, and create, update,
...
[subset of consumer procedures](consumer.html#label-dcr-sproc-consumer-manage-role-access), such as `consumer.run_analysis`, but not the ability
...
* To revoke run privileges on a specific clean room from a specific role, call [revoke\_run\_on\_cleanrooms\_from\_role](consumer.html#label-dcr-consumer-revoke-run-on-cleanrooms-from-role).
...
[create a clean room managed account](managed-accounts.html#label-cleanrooms-intro-managed-account) for them. Remember that you invite an account to
...
[enable Cross-Cloud Auto-Fulfillment](enabling-laf.html#label-cleanrooms-get-started-ccaf) before you can add them as a collaborator.
...
3. Do one of the following:
   ...
   * If the collaborator is not a Snowflake customer:
     ...
     1. You can contact [Snowflake Support](https://docs.snowflake.com/user-guide/contacting-support) to grant you the ability to create a [managed account](managed-accounts.html#label-cleanrooms-intro-managed-account).
...
[create a clean room managed account](managed-accounts.html#label-cleanrooms-intro-managed-account) for them.
