...
For more information about role access, see [Grant limited API access (run roles)](manage-dcr-users.html#label-dcr-grant-limited-access).
...
* [cleanroom\_names](developer-introduction.html#label-dcr-about-clean-room-names) *(Array of strings)* - Names of all the clean rooms on which to grant limited access to the specified role.
...
* [cleanroom\_names](developer-introduction.html#label-dcr-about-clean-room-names) *(Array of strings)* - Names of one or more clean rooms in this account.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room to install.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of clean room to check the status of.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of clean room to uninstall.
...
Install a clean room created on another cloud region. [Learn more.](enabling-laf)
...
[must be configured by an account administrator](enabling-laf).
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - The name of the cross-region clean room that will be installed.
...
* `provider_account_name` - (String) [Data sharing account identifier](../admin-account-identifier.html#label-account-name-data-sharing) of the provider.
...
* `provider_account` - (String) One or more comma-delimited provider [Data sharing account identifiers](../admin-account-identifier.html#label-account-name-data-sharing).
...
For more information about provider-run analysis, see [Provider-run analyses](demo-flows/provider-run-analysis).
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room with the template to approve.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - The name of the clean room where the provider can run analyses.
...
* `enable_differential_privacy` - (Boolean) If TRUE, enable differential privacy for all templates listed in `template_names`.
  ...
  `consumer.set_privacy_settings`. [Learn more.](differential-privacy)
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room. If the template is not present in this
...
For more information about registering data, see [Registering data](register-data).
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - The name of the clean room into which the provider can link Iceberg tables or external tables.
...
must [grant your clean room access to that policy database](register-data.html#label-dcr-link-views-with-external-policies) to be able to link the data
into a clean room.

**Arguments:**

* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room to link data into.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room for which access should be removed.
...
[Manage policies](policies) on your data in a clean room that you have installed.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room where the join policy is applied.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room where the column policy is applied.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room to describe.
...
**Description:** View the raw JinjaSQL of the specified template. If a template [was obscured](provider.html#dcr-provider-add-custom-sql-template) by applying the `is_obfuscated` argument, you can’t see the template source code.

**Arguments:**

* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room that holds the template.
...
> * [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room that has the template.
...
The following procedures allow users to work with [template chains](developer-template-chains) in the clean room.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room to list template chains for.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room with the template chain to describe.
...
* If [differential privacy](differential-privacy) is enabled, the query can fail if you have reached your
  budget limit for this template.
* If a template [was obscured](provider.html#dcr-provider-add-custom-sql-template) by applying the `is_obfuscated` argument, you must use
  Snowflake Enterprise Edition or higher to be able to run the template.

**Arguments:**

* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room in which to run the analysis.
...
The following procedures manage <activation>, or the saving of results to a consumer’s or
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the cleanroom in which to set the activation policy.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room where the provider is requesting to run a template.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room in which to run the activation.
...
The following APIs allow you to add consumer-defined templates to a clean room. For more information, see [consumer-written templates](demo-flows/custom-templates.html#label-dcr-consumer-written-templates).
...
room. See [Consumer-written custom templates](demo-flows/custom-templates.html#label-dcr-consumer-written-templates).

**Arguments:**

* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room where the template is added.
...
* `template_definition` - (String) The JinjaSQL template. [Learn the template syntax.](custom-templates)
...
For more information about consumer-defined templates, see [Consumer-written custom templates](demo-flows/custom-templates.html#label-dcr-consumer-written-templates).
...
[Consumer-submitted code](demo-flows/custom-code.html#label-dcr-consumer-submitted-code).
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - The clean room to list template requests for.
...
If a template [was obscured](provider.html#dcr-provider-add-custom-sql-template) by applying the `is_obfuscated` argument, you must use Snowflake
...
**Description:** Lists all templates in the clean room. If a template [was obscured](provider.html#dcr-provider-add-custom-sql-template) by
...
These procedures control [differential privacy](differential-privacy) in the clean room. You can also specify differential privacy at the template level when you call `consumer.enable_templates_for_provider_run`.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* Name of the clean room. The clean room must be installed for this
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room where these settings should be applied.
* `privacy_settings` - (String) A string JSON object that specifies privacy settings when custom templates are run by a provider. Here is
  ...
  :   [Available privacy settings](differential-privacy.html#label-dcr-available-privacy-settings) to see what fields you can provide in this object.
...
[Read more about using Snowpark Container Services in your clean rooms.](demo-flows/machine-learning)
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room where the container should be loaded.
...
[Recent feature updates](../../release-notes/new-features.html#label-new-features-features).) This procedure updates
[SAMOOHA\_BY\_SNOWFLAKE\_LOCAL\_DB](installation-details).
