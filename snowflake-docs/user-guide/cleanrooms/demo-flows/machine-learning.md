...
url: "https://docs.snowflake.com/en/user-guide/cleanrooms/demo-flows/machine-learning"
---
...
The “high value” users are identified with the filter\_clause in the query below. If *c.SALES\_DLR* represented the amount of sales per user, then a valid filter could look like *c.HIGH\_VALUE > 4000*.
