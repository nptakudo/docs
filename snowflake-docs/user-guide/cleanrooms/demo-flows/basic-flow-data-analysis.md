...
url: "https://docs.snowflake.com/en/user-guide/cleanrooms/demo-flows/basic-flow-data-analysis"
---
...
![Basic data flow direction in a consumer-run analysis](../../../_images/consumer-run-analysis.svg)
...
app\_wh is one of a [number of warehouses](../installation-details.html#label-cleanrooms-installation-details-warehouses) with access to the API. Choose the
warehouse that is appropriate for your needs. (You can also [use your own warehouse](../admin-tasks.html#label-cleanrooms-admin-add-warehouse), if you
choose.)
...
[other supported data objects](../register-data.html#label-dcr-supported-linkable-objects) into a clean room. When you link data, the API creates a hidden,
...
imported into the clean room (unless you enable [free-form SQL queries](../web-app-sql-template) on your data).
...
object is available for linking by any clean room in the account. [Learn more about registration.](../register-data)
...
[clean room join policy](../policies.html#label-dcr-join-policies) on your data. A clean room join policy specifies which columns can be
joined on in queries run by collaborators. Your own join policies don’t constrain your own
queries.

Clean rooms support a [few types of data policies](../policies) that you can set on linked data. These policies
...
The template is responsible for [using JinjaSQL filters to enforce policies](../custom-templates.html#label-dcr-template-policies). If the template does
...
[Learn more about join policies.](../policies.html#label-dcr-join-policies)
...
[Understanding clean room table policies](../policies).

By default, only consumers can run templates. If a
[provider wants to run a template](provider-run-analysis), they must ask permission from the
consumer. Similarly, if a [consumer wants to upload a template](custom-templates.html#label-dcr-consumer-written-templates), they must ask permission from
the provider.

For more information about creating a custom template, read [Add custom templates to a clean room](custom-templates) and
[Custom clean room template reference](../custom-templates).
...
[Learn more about column policies.](../policies.html#label-dcr-column-policies)
...
consumer account locators and [consumer data sharing account IDs](../../admin-account-identifier.html#label-account-name-data-sharing).
...
[cross-cloud auto-fulfillment](../enabling-laf) before the consumer can be added to the clean room. You can see
...
[Read more about clean room versioning.](../dcr-versions)
...
[warehouse that SAMOOHA\_APP\_ROLE can access](../installation-details.html#label-cleanrooms-installation-details-warehouses). However, unlike the provider, the
...
[Learn how to grant limited API access.](../manage-dcr-users.html#label-dcr-grant-limited-access)
...
see [Understanding clean room table policies](../policies).
...
[obfuscated the code](../provider.html#dcr-provider-add-custom-sql-template)). This can be useful to help you understand the query better. You can
...
[something more appropriate](../installation-details.html#label-cleanrooms-installation-details-warehouses).
...
[See instructions to upload a SQL worksheet into your Snowflake account](../tutorials-and-samples.html#label-dcr-list-of-sample-notebooks-and-worksheets).
