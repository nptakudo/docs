...
Currently available in [these regions](web-app-introduction.html#label-web-app-hosting).

Not available in government and VPS deployments.

This page describes procedures used by clean rooms API consumers to manage their clean rooms. For coding setup instructions, see [Coding setup](developer-introduction.html#label-cleanrooms-coding-setup).
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room to get information about.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Clean room name, 80 characters maximum. Valid characters: `[A-Z,a-z,0-9,_]` and spaces.
...
Where `<cleanroom_name>` [follows this format](developer-introduction.html#label-dcr-about-clean-room-names).
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Clean room name.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room to delete.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room in which consumer-run analyses are allowed.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Clean room where consumer-run analysis is being disabled.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room to check.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room to publish or update.
...
[Managing Cross-Cloud Auto-Fulfillment in Snowflake Data Clean Rooms](enabling-laf).
...
[Learn more about registering data.](register-data)
...
If successful and all security scans pass, this generates a [new patch version](dcr-versions) of the clean
room.
...
If successful, this will generate a [new patch version](dcr-versions) of the clean room.

**Arguments:**

* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - The name of the clean room into which the provider can link Iceberg or external tables.
...
must [grant your clean room access to that policy database](register-data.html#label-dcr-link-views-with-external-policies) to enable linking the data
into a clean room.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room with access to the objects.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of clean room linked to these data sets.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room to restrict.
...
Join policies in data clean rooms are not the same as [Snowflake-wide join policies](../join-policies). Join policies for clean
rooms are set only by using this procedure; join policies set on tables outside of clean rooms are ignored by clean rooms.

[Learn more about table policies in clean rooms.](policies)
...
Learn more about clean room policies: [Understanding clean room table policies](policies).
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room where the join policy should be enforced.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room to query.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)*
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Clean room to query.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room with this template.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room to add templates to.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room from which to remove all templates.
...
[Learn how to create custom templates.](custom-templates)
...
If the template is used by the consumer to [activate results back to the provider](activation),
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room to which this template is applied.
...
[Learn how to design user input forms for custom templates.](demo-flows/custom-templates.html#label-dcr-define-user-form)
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - The name of the clean room that contains this template. The submitted form applies only to
...
* `template_information` - (Dict) Meta information about the template to show in the clean rooms UI. The following properties must or can be
  ...
  + `warehouse_hints` *(Object)*: Recommends what type of warehouse to use to run the analysis. This is an object with the
    ...
    - `snowpark_optimized` *(Boolean)*: Whether to use a [Snowpark-optimized warehouse](../warehouses-snowpark-optimized) to
  ...
  + `activation_template_name` - *(String)* Name of an activation template in this clean room. Use the template name without any
    `cleanroom` prefix. [Learn about activation templates.](custom-templates.html#label-dcr-custom-templates-activation)
...
> * [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - The name of the clean room.
...
[Consumer-written custom templates](demo-flows/custom-templates.html#label-dcr-consumer-written-templates).
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - View consumer requests to add a template to this clean room.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room the user wants to add the template to.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - The name of the clean room to which this request applies.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room to which this request applies.
...
Use the following commands to create and manage [template chains](developer-template-chains).
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room where the template chain should be added.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room associated with this template chain.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - The clean room that is assigned this template chain.
...
[Read more about activation](activation).
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room where activation should be allowed.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - The name of the clean room to report on.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Clean room that contains the activation template.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room in which the activation was requested. You
...
[Learn how to run a provider analysis.](demo-flows/provider-run-analysis)
...
[Learn more about provider-run analyses.](demo-flows/provider-run-analysis)
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room that should enable provider-run analysis.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room where provider-run analysis should be
  disabled.
...
* The consumer must have [approved provider-run analyses](consumer.html#dcr-consumer-enable-templates-for-provider-run) for the specified template.
* All [join](consumer.html#dcr-consumer-set-join-policy)) and [column](consumer.html#dcr-consumer-set-column-policy)) policies on the consumer data and the template
  must be respected.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room where the template should run.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room where the request was made.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room for which the request was sent.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - The clean room of interest.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room to share with the specified users. Users can install the clean room using either the
...
* `consumer_account_names` - (String) A comma-delimited list of
  [consumer data sharing account IDs](../admin-account-identifier.html#label-account-name-data-sharing) for the consumer in the format
...
* `privacy_settings` - (String, optional) If present, applies privacy settings to custom templates when used by any of the users in
  ...
  in this clean room to enable differential privacy. [See the available fields for this object.](differential-privacy.html#label-dcr-available-privacy-settings)
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - The ID of the clean room (not the user-friendly name).
...
Enable a clean room to be shared with a consumer on another cloud region. [Learn more.](enabling-laf)
...
**Description:** Sets the refresh interval for [clean room data](enabling-laf.html#label-dcr-laf-refresh-rates) between the provider and the consumer
...
[Learn how to upload and use Python code in a clean room.](demo-flows/custom-code)
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room where the script should be loaded.
...
* `packages` - (Array of string) List of any Python package names used by the code. Clean rooms natively supports all the packages
  ...
  If you need a package not listed there, you must use [Snowpark Container Services in a clean room.](demo-flows/snowpark.html#label-dcr-snowpark-spcs)
* `ret_type` - (String) SQL data type of the value returned by the function `handler`.
  ([See some equivalent Python and SQL types](../../developer-guide/udf-stored-procedure-data-type-mapping.html#label-sql-java-data-type-mappings). Snowflake
...
* `packages` - (Array of string) List of any Python package names used by the code. Clean rooms natively supports all the packages
  ...
  [Snowpark Container Services in a clean room.](demo-flows/snowpark.html#label-dcr-snowpark-spcs)
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room where you want to upload Python code.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room where you want to upload files.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room to check the status of.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room to mount request logs for.
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* - Name of the clean room to review request logs for.
...
These commands control differential privacy at the user level or provider account level. [Learn more about differential privacy.](differential-privacy)
...
* `privacy_settings` - (Object) A JSON object that specifies differential privacy settings for one or more templates. Settings are applied
  to all templates run by the specified consumer. [See the available fields for this object.](differential-privacy.html#label-dcr-available-privacy-settings)
...
[costs associated with differential privacy in your account](cleanroom-cost). If the differential privacy task is
...
[Learn more about managing differential privacy.](differential-privacy)
...
These procedures enable you to [use Snowpark Container Services inside a clean room](demo-flows/snowpark.html#label-dcr-snowpark-spcs).
...
[Learn about using Snowpark Container Services in a clean room.](demo-flows/snowpark.html#label-dcr-snowpark-spcs)
...
`library.apply_patch` with each [new release](../../release-notes/new-features.html#label-new-features-features).
...
[Recent feature updates](../../release-notes/new-features.html#label-new-features-features).) This procedure updates [samooha\_by\_snowflake\_local\_db](installation-details).
...
* [cleanroom\_name](developer-introduction.html#label-dcr-about-clean-room-names) *(String)* : Name of the clean room to patch.
