...
* **Differential Privacy:** Enabled on the provider’s account to support enforcement of differential privacy. This operation prevents
  ...
  this cost by [disabling the differential privacy task](provider.html#dcr-provider-diff-privacy-functions).
...
To see the cost incurred by a warehouse, sign in to [Snowsight](../ui-snowsight-gs.html#label-snowsight-getting-started-sign-in).
