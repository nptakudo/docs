...
4. Select Show Info Panel. The information panel slides open.
   ...
   > ![Show the info panel of a Google Cloud Platform bucket](../../_images/gcp-bucket-show-info-panel.png)
...
1. In the left navigation of the clean room, select Connectors and expand the Google Cloud section. If you are signed out of the
   clean room, see [Sign in to the clean rooms UI](web-app-introduction.html#label-cleanroom-web-app-sign-in).
