...
url: "https://docs.snowflake.com/en/user-guide/cleanrooms/lookalike-audience-modeling-template"
---
...
environment. [See instructions to upload a SQL worksheet into your Snowflake account](tutorials-and-samples.html#label-dcr-list-of-sample-notebooks-and-worksheets).
