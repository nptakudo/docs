...
url: "https://docs.snowflake.com/en/user-guide/security-access-privileges-shares"
---
...
name, last name, and an email address. To modify the user profile in Snowsight, see [Add user details to your user profile](ui-snowsight-profile.html#label-user-details-and-preferences).
...
For more information on these options, see [How to share database objects](data-sharing-gs.html#label-data-sharing-share-options).
