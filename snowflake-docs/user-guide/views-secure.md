...
[Differences between Account Usage and Information Schema](../sql-reference/account-usage.html#label-differences-between-account-usage-and-information-schema).)
...
The internals of a secure view are not exposed in [Query Profile](ui-snowsight-activity) (in the web interface). This is the
...
* Use randomized identifiers (e.g. generated by [UUID\_STRING](../sql-reference/functions/uuid_string)) instead of sequence-generated values.
