...
information, see [Private connectivity to external stages and Snowpipe automation for Microsoft Azure](data-load-azure-private).
...
* **Configuration tasks (complete as needed):**
  ...
  + [Allow the VNet subnet IDs](data-load-azure-allow)
  + [Configure an Azure container for loading data](data-load-azure-config)
  + [Create an Azure stage](data-load-azure-create-stage)
* **Data loading tasks (complete for each set of files you load):**

  + [Copy data from an Azure stage](data-load-azure-copy)
