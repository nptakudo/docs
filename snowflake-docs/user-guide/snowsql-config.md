...
* While connecting to Snowflake, you can use the `-o` or `--option` connection parameter to set these options. For more information, see [Connection parameters reference](snowsql-start.html#label-snowsql-connection-parameters).
* After connecting to Snowflake, you can use the `!set` command to set these options for the session. For more information, see [Commands reference](snowsql-use.html#label-snowsql-commands).
...
For more information, see [Using variables](snowsql-use.html#label-snowsql-variables).
...
* Using the `-o` or `--option` [parameter](snowsql-start.html#label-snowsql-connection-parameters) when connecting to Snowflake.
* Using the `!set` [command](snowsql-use.html#label-snowsql-commands) once connected to Snowflake.
...
>     the [USE\_CACHED\_RESULT](../sql-reference/parameters.html#label-use-cached-result) session parameter is enabled.
>
> Default:
...
>
> Description:
> :   Substitutes variables with the values. See [Using variables](snowsql-use.html#label-snowsql-variables).
>
> Default:
