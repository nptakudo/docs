...
url: "https://docs.snowflake.com/en/user-guide/data-load-dirtables-auto-s3"
---
...
* [Virtual Private Snowflake (VPS)](intro-editions) and [AWS PrivateLink](admin-security-privatelink)
...
[Configuring secure access to Amazon S3](data-load-s3-config) for additional storage access options.
