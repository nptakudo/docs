...
[shared with your account](data-sharing-intro) from the Snowflake SFC\_SAMPLES account.
If you do not see the database, you can create it yourself. Refer to [Use the sample database](sample-data-using).
...
* [Use the sample database](sample-data-using)
* [Sample data: TPC-DS](sample-data-tpcds)
* [Sample data: TPC-H](sample-data-tpch)
* [Sample Data: OpenWeatherMap — *Deprecated*](sample-data-openweathermap)
