...
For instructions, see [Configure a catalog integration for AWS Glue Iceberg REST](tables-iceberg-configure-catalog-integration-rest-glue).
...
[Refresh the metadata for a table](tables-iceberg-manage.html#label-tables-iceberg-refresh-metadata-general).
