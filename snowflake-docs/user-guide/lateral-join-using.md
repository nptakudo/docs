...
url: "https://docs.snowflake.com/en/user-guide/lateral-join-using"
---
...
For example, if the inline view is a [subquery](querying-subqueries), the subquery can process rows from the table to the left of the subquery. For example:
...
This behavior is somewhat similar to a [correlated subquery](querying-subqueries.html#label-correlated-vs-uncorrelated-subqueries).
