...
For example, to set the [DATE\_OUTPUT\_FORMAT](../sql-reference/parameters.html#label-date-output-format) session parameter:
...
For example, to set the [DATE\_OUTPUT\_FORMAT](../sql-reference/parameters.html#label-date-output-format) session parameter back to its default value:
