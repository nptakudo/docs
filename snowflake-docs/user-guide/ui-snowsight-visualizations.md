...
url: "https://docs.snowflake.com/en/user-guide/ui-snowsight-visualizations"
---

# Visualizing worksheet data

This topic describes how to visualize your SQL worksheet results using charts in [Snowsight](ui-snowsight-gs.html#label-snowsight-getting-started-sign-in).
...
You can also visualize your data [using dashboards](ui-snowsight-dashboards).

Note

Chart generation and data transformations in worksheets can result in compute usage. For guidance on managing these costs, see [Optimizing cost](cost-optimize).
...
[![Example line chart showing orders grouped by day.](../_images/snowsight-visualizations-chart.png)](../_images/snowsight-visualizations-chart.png)
...
* Select the chart type to choose a different type, for example, Bar.
  ...
  [![Chart type is a button labeled with the currently selected type of chart.](../_images/snowsight-visualizations-chart-type.png)](../_images/snowsight-visualizations-chart-type.png)

You can manage the columns in your chart with the Data section:

[![The data section contains buttons labeled with the column names.](../_images/snowsight-visualizations-data.png)](../_images/snowsight-visualizations-data.png)
...
* Modify how column data is represented in the chart. For example, change the bucketing for a time column from day to minutes.
  ...
  [![For assistive technology, the column attributes are rendered as a collection of list tables and buttons.](../_images/snowsight-visualizations-column-attributes.png)](../_images/snowsight-visualizations-column-attributes.png)
...
[![The appearance section for a heatgrid chart type, with options to label rows, label columns, or color cells based on values.](../_images/snowsight-visualizations-appearance.png)](../_images/snowsight-visualizations-appearance.png)
