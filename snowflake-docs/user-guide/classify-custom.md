...
If there isn’t a [native semantic category](classify-native) that detects your domain-specific sensitive data, you can
...
For an example of using the CUSTOM\_CLASSIFIER class to create and use a custom classifier, see [Example](classify-custom-using.html#label-custom-classification-example).
...
[custom\_classifier!ADD\_REGEX](../sql-reference/classes/custom_classifier/methods/add_regex) method on the instance.
