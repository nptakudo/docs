...
url: "https://docs.snowflake.com/en/user-guide/cortex-code/workflows"
---
...
[Skills](extensibility.html#extensibility-skills)
:   Specialized skills for semantic models, agents, and documents

[Cortex Analyst](../snowflake-cortex/cortex-analyst)
