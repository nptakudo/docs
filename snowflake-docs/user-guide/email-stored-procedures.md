...
url: "https://docs.snowflake.com/en/user-guide/email-stored-procedures"
---
...
This feature uses the [notification integration](email-notifications.html#label-create-email-notification-integration) object, which is a Snowflake
...
validate the email addresses of the recipients. For details, see [Notifications in Snowflake](about-notifications).
