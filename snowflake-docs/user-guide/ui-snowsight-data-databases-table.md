...
url: "https://docs.snowflake.com/en/user-guide/ui-snowsight-data-databases-table"
---
...
To work with tables in Snowsight, you must use a role with the relevant [table privileges](security-access-control-privileges.html#label-table-privileges).
...
[![Table details shown for a standard table in Snowsight, described in the surrounding text.](../_images/snowsight-data-table-details.png)](../_images/snowsight-data-table-details.png)
...
See [Manage object privileges with Snowsight](security-access-control-configure.html#label-snowsight-manage-object-privileges).
