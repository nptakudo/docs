...
url: "https://docs.snowflake.com/en/user-guide/data-cdp"
---
...
Most Continuous Data Protection features are included standard for all [Snowflake editions](intro-editions) (i.e. no additional licensing is
...
[Data storage considerations](tables-storage-considerations).
