...
url: "https://docs.snowflake.com/en/user-guide/password-authentication"
---
...
* The password policy can be managed with SQL using [Snowflake CLI](../developer-guide/snowflake-cli/index), [SnowSQL](snowsql) or a
...
(i.e. has the global APPLY PASSWORD POLICY privilege, as shown in [step 2](#label-pwd-policy-grant-privileges)).
...
For more information, see: [Access control privileges](security-access-control-privileges)
...
For more information, see [Configuring access control](security-access-control-configure)
