...
url: "https://docs.snowflake.com/en/user-guide/security-mfa-second-factor"
---

# Configuring a second factor of authentication

When a password user is enrolled in [Multi-factor authentication (MFA)](security-mfa), they must use a second factor of
...
Your administrator controls which factors are available to you. For more information, see [Restricting which MFA methods are available](security-mfa.html#label-mfa-restrict-methods).
...
information, see [Prerequisite](security-mfa-duo.html#label-mfa-duo).
...
[Duo authenticators](security-mfa-duo) (Duo push and passcodes).
