...
For more information, refer to [Resource locking](../sql-reference/transactions.html#label-txn-locking).
...
which can cause latency for DML operations. For more information, refer to [Resource locking](../sql-reference/transactions.html#label-txn-locking).
...
[DATA\_RETENTION\_TIME\_IN\_DAYS](../sql-reference/parameters.html#label-data-retention-time-in-days) or [MAX\_DATA\_EXTENSION\_TIME\_IN\_DAYS](../sql-reference/parameters.html#label-max-data-extension-time-in-days) parameter
...
For more information, see [Data retention period and staleness](streams-intro.html#label-streams-staleness).
...
* Manage privileges on the stream. See [Manage object privileges with Snowsight](security-access-control-configure.html#label-snowsight-manage-object-privileges).
