...
url: "https://docs.snowflake.com/en/user-guide/data-quality-expectations"
---
...
a DMF and an expectation, see [Use Snowsight to set up data quality checks](data-quality-ui-setup).
