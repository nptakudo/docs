...
* [Query a list of all the unstructured files on a stage](data-load-dirtables-query).
  ...
  including the size, a timestamp of when it was last modified, and its [Snowflake file URL](unstructured-intro.html#label-unstructured-data-urls).
* [Create views of unstructured data](data-load-dirtables-query.html#label-data-load-dirtables-rich-views).
...
* [Construct a file processing pipeline](data-load-dirtables-pipeline). You can use a directory table with
  the Snowpark API or external functions to create a file processing pipeline.

To register changes to files on a stage, you can [refresh the directory table metadata](data-load-dirtables-manage.html#label-directory-table-refreshes).
...
* [Manage directory tables](data-load-dirtables-manage)
* [Query directory tables](data-load-dirtables-query)
* [Automated directory table metadata refreshes](data-load-dirtables-auto)
* [Build a data processing pipeline using a directory table](data-load-dirtables-pipeline)
