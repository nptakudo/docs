...
url: "https://docs.snowflake.com/en/collaboration/virtual-private-snowflake/about-vps-collaboration"
---
...
If you’re a data consumer in search of listings, see [Finding consumers for private listings](vps-collaboration-for-providers.html#label-locating-vps-priv-listings-for-consumers).

If you’re a data provider, find more information on locating consumers who might be interested in
your listing in [Finding consumers for private listings](vps-collaboration-for-providers.html#label-finding-consumers-vps-private-listings-for-providers).
...
Currently in preview, VPS providers can publish free and limited trial listings on the Snowflake Marketplace. For more information, see [As a VPS provider, create a listing in Snowflake Marketplace](../provider-listings-creating-publishing.html#label-listings-vps-provider-create-in-marketplace)
