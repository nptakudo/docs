...
objects associated with your model instance, navigate to your [Account Usage views](sql-reference/account-usage.html#label-account-usage-views)
...
Before you use ML functions, you must ensure [AUTOCOMMIT](sql-reference/transactions.html#label-txn-autocommit) is enabled in your session. AUTOCOMMIT is
