...
| --- | --- |
| CopyExpand  ``` 'string with a \' character' ```  Show lessSee more  Scroll to top | CopyExpand  ``` $$string with a ' character$$ ```  Show lessSee more  Scroll to top |
| CopyExpand  ``` 'regular expression with \\ characters: \\d{2}-\\d{3}-\\d{4}' ```  Show lessSee more  Scroll to top | CopyExpand  ``` $$regular expression with \ characters: \d{2}-\d{3}-\d{4}$$ ```  Show lessSee more  Scroll to top |
| CopyExpand  ``` 'string with a newline\ncharacter' ```  Show lessSee more  Scroll to top | CopyExpand  ``` $$string with a newline character$$ ```  Show lessSee more  Scroll to top |
