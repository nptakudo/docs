...
* A DECFLOAT value can’t be stored as a
  [semi-structured data type](data-types-semistructured) or
  [structured data type](data-types-structured).

  To store a DECFLOAT value as a string for one of these types, you can [cast](data-type-conversion)
