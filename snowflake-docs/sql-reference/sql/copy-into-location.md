...
To learn more, see [Explicitly convert numeric columns to Parquet data types](../../user-guide/data-unload-considerations.html#label-converting-numeric-columns-to-parquet-data-types).
