...
[behavior change bundle](../behavior-change-policy.html#label-behavior-change-bundles) is enabled in your account and how to enable or disable it.
...
currently available behavior change bundles, see [Behavior change announcements](../behavior-changes).
...
In the `2024_04` [bundle](2024_04/bcr-1355), there are changes to the values for precision and
...
`FORCE` [keyword](../../user-guide/security-column-intro.html#label-security-column-intro-replace-policy).
