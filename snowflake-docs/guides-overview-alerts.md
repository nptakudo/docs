...
url: "https://docs.snowflake.com/en/guides-overview-alerts"
---
...
:   You can configure Snowflake to send notifications about [Snowpipe](user-guide/data-load-snowpipe-intro) and
    [task](user-guide/tasks-intro) errors to a cloud provider queue (Amazon SNS, Microsoft Azure Event Grid, or Google
    Cloud Pub/Sub).
